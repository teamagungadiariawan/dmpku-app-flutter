...
class TransaksiProsesAltPage extends StatefulWidget {
  static const String routeName = '/member/produk/transaksi_proses_alt';

  @override
  _TransaksiProsesAltPageState createState() => _TransaksiProsesAltPageState();
}

class _TransaksiProsesAltPageState extends State<TransaksiProsesAltPage> {
  @override
          ...
          body: SafeArea(
            child: Center(
              child: Container(
                ...
                child:
                    BlocBuilder<TransaksiProsesProvider, TransaksiProsesState>(
                                ...
                                children: [
                                  ...
                                  Column(
                                    ...
                                    children: [
                                      ...
                                      Text(
                                        "Rp ${state.product.hargaFormmated}",
                            ...
                            Container(
                              ...
                              child: Row(
                                ...
                                children: [
                                  ...
                                  InkWell(
                                    onTap: () {
                                      _copyToClipboard(context, state.tujuan);
                                    },
                                    child: Icon(
                                      Icons.copy,
                                      size: 20,
