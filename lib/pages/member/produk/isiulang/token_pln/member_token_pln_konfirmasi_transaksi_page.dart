...
class MemberTokenPlnKonfirmasiTransaksiPage extends StatefulWidget {
  static const routeName =
      '/member/produk/isiulang/token-pln/konfirmasi-transaksi';

  const MemberTokenPlnKonfirmasiTransaksiPage({super.key});

  @override
  State<MemberTokenPlnKonfirmasiTransaksiPage> createState() =>
      _MemberTokenPlnKonfirmasiTransaksiPageState();
}

class _MemberTokenPlnKonfirmasiTransaksiPageState
    extends State<MemberTokenPlnKonfirmasiTransaksiPage> {
  void closePage() {
    pop();
  }
  ...
  Widget _buildProductInfo(BuildContext context, MemberTokenPlnState state) {
    return Container(
      padding: paddingCard,
      decoration: BoxDecoration(
        color: context.isDarkMode ? slate[600] : slate[200],
      ...
      child: Row(
        children: [
          Image.network(state.selectedProduct.imgproduk, width: 48, height: 48),
          const Gap(8),
          Expanded(
            child: Column(
              crossAxisAlignment: CrossAxisAlignment.start,
        ...
        return Row(
          children: [
            ...
            CustomButton(
              ...
              text: "Lanjutkan",
              onPressed: () {
                getMemberTokenPlnProvider(context).konfirmasiTrx(context);
              },
