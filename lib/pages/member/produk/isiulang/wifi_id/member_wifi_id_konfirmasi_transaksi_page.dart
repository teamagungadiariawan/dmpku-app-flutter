...
class MemberWifiIdKonfirmasiTransaksiPage extends StatefulWidget {
  static const routeName =
      '/member/produk/isiulang/wifi_id/konfirmasi-transaksi';

  const MemberWifiIdKonfirmasiTransaksiPage({super.key});

  @override
  State<MemberWifiIdKonfirmasiTransaksiPage> createState() =>
      _MemberWifiIdKonfirmasiTransaksiPageState();
}

class _MemberWifiIdKonfirmasiTransaksiPageState
    extends State<MemberWifiIdKonfirmasiTransaksiPage> {
  void closePage() {
    getMemberWifiIdProvider(context).resetKonfirmasi();
    pop();
  }
  ...
  Widget _buildProductInfo(BuildContext context, MemberWifiIdState state) {
    return Container(
      padding: paddingCard,
      decoration: BoxDecoration(
        color: context.isDarkMode ? slate[600] : slate[200],
        ...
        return Row(
          children: [
            ...
            CustomButton(
              ...
              text: "Lanjutkan",
              onPressed: () {
                getMemberWifiIdProvider(context).konfirmasiTrx(context);
              },
