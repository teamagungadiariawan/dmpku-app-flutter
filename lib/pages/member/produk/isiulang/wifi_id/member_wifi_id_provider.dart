...
// STATE
// ============================================================
class MemberWifiIdState extends Equatable {
  // Product API
...
// CUBIT
// ============================================================
class MemberWifiIdProvider extends Cubit<MemberWifiIdState> {
  ...
  void konfirmasiTrx(BuildContext context) async {
    ...
    KonfirmasiPinDialog.show<MemberWifiIdProvider, MemberWifiIdState>(
      context,
      // Title & Subtitle default
      title: 'Konfirmasi Transaksi Wifi ID ${state.selectedProduct.namaproduk}',
      subtitle: 'Masukkan PIN untuk melanjutkan transaksi Wifi ID',
  ...
  Future<void> _prosesKonfirmasi(BuildContext context, String pin) async {
    ...
    try {
      var tujuan = state.tujuan.trim();
      var pintrx = TipeInput.numericOnly.filter(pin);

      final result = await _produkService.bayarWifiIdMember(
...
MemberWifiIdProvider getMemberWifiIdProvider(BuildContext context) =>
    context.read<MemberWifiIdProvider>();
