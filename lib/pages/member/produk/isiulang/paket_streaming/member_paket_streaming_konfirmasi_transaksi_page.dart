...
class MemberPaketStreamingKonfirmasiTransaksiPage extends StatefulWidget {
  static const routeName =
      '/member/produk/isiulang/paket-streaming/konfirmasi-transaksi';

  const MemberPaketStreamingKonfirmasiTransaksiPage({super.key});

  @override
  State<MemberPaketStreamingKonfirmasiTransaksiPage> createState() =>
      _MemberPaketStreamingKonfirmasiTransaksiPageState();
}

class _MemberPaketStreamingKonfirmasiTransaksiPageState
    extends State<MemberPaketStreamingKonfirmasiTransaksiPage> {
  void closePage() {
    pop();
  }
  ...
  Widget _buildDetailContent(BuildContext context) {
    return BlocBuilder<MemberPaketStreamingProvider,
  ...
  Widget _buildProductInfo(
      BuildContext context, MemberPaketStreamingState state) {
    return Container(
      padding: paddingCard,
      decoration: BoxDecoration(
        color: context.isDarkMode ? slate[600] : slate[200],
        ...
        return Row(
          children: [
            ...
            CustomButton(
              ...
              text: "Lanjutkan",
              onPressed: () {
                getMemberPaketStreamingProvider(context).konfirmasiTrx(context);
              },
