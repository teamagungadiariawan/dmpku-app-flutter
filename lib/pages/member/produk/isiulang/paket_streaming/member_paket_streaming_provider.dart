...
class MemberPaketStreamingState extends Equatable {
  // Provider API
  ...
  const MemberPaketStreamingState({
    // Provider API
  ...
  MemberPaketStreamingState copyWith({
    // Provider API
    ...
    return MemberPaketStreamingState(
      // Provider API
...
class MemberPaketStreamingProvider extends Cubit<MemberPaketStreamingState> {
  ...
  void konfirmasiTrx(BuildContext context) async {
    ...
    KonfirmasiPinDialog.show<MemberPaketStreamingProvider,
      ...
      title:
          'Konfirmasi Transaksi Paket Streaming ${state.selectedProduct.namaproduk}',
  ...
  Future<void> _prosesKonfirmasi(BuildContext context, String pin) async {
    ...
    try {
      ...
      final result = await _produkService.bayarStreamingMember(
  ...
  Future<void> fetchProviders() async {
    ...
    try {
      final result = await _produkService.getStreamingMemberProviders();
      if (!result.status) {
        emit(
          state.copyWith(
  ...
  Future<void> fetchProducts() async {
    ...
    try {
      final result = await _produkService.getStreamingMemberProducts(
