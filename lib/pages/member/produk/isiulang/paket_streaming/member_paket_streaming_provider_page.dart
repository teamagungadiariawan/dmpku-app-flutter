...
class MemberPaketStreamingProviderPage extends StatefulWidget {
  static const routeName = '/member/produk/isiulang/paket-streaming/provider';

  const MemberPaketStreamingProviderPage({super.key});

  @override
  State<MemberPaketStreamingProviderPage> createState() =>
      _MemberPaketStreamingProviderPageState();
}

class _MemberPaketStreamingProviderPageState
    extends State<MemberPaketStreamingProviderPage> {
  final shakeKey = GlobalKey<ShakeErrorWidgetState>();

  @override
  void dispose() {
    getMemberPaketStreamingProvider(context).resetState();
    super.dispose();
  }
  ...
  Widget build(BuildContext context) {
    return AnnotatedRegion<SystemUiOverlayStyle>(
      ...
      child: WillPopScope(
        ...
        child: Scaffold(
          appBar: CustomAppBar(
            title: "Pilih Provider Paket Streaming",
            onBackButtonPressed: () {
              closePage();
            },
          ),
        ...
        return RefreshableList(
          ...
          itemBuilder: (context, provider, index) {
            return CardProvider(
              ...
              onPressed: () {
                pushNamed(MemberPaketStreamingProdukPage.routeName);
            ...
            children: [
              ...
              Expanded(
                child: TextField(
                  ...
                  onChanged: getMemberPaketStreamingProvider(
                    context,
                  ).setSearchProvider,
