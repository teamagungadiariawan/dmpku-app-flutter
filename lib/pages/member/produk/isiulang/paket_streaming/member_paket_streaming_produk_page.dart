...
class MemberPaketStreamingProdukPage extends StatefulWidget {
  static const routeName = '/member/produk/isiulang/paket-streaming/produk';

  const MemberPaketStreamingProdukPage({super.key});

  @override
  State<MemberPaketStreamingProdukPage> createState() =>
      _MemberPaketStreamingProdukPageState();
}

class _MemberPaketStreamingProdukPageState
    extends State<MemberPaketStreamingProdukPage> {
  final shakeKey = GlobalKey<ShakeErrorWidgetState>();

  void closePage() {
    getMemberPaketStreamingProvider(context).resetProduct();
    pop();
  }
  ...
  Widget build(BuildContext context) {
    return AnnotatedRegion<SystemUiOverlayStyle>(
      ...
      child: WillPopScope(
        ...
        child: Scaffold(
          appBar: CustomAppBar(
            title: getMemberPaketStreamingProvider(
              context,
          ...
          bottomNavigationBar:
              BlocBuilder<MemberPaketStreamingProvider, MemberPaketStreamingState>(
                ...
                builder: (context, state) {
                  ...
                  return Padding(
                    ...
                    child: ButtonCheckout(
                      ...
                      onContinue: () {
                        getMemberPaketStreamingProvider(context).setNewKonfirmasi();
                      },
                    ),
                  );
                },
  ...
  Widget _buildPhoneNumberCard(BuildContext context) {
    return BlocBuilder<MemberPaketStreamingProvider, MemberPaketStreamingState>(
      buildWhen: (previous, current) =>
          previous.tujuan != current.tujuan ||
          previous.tujuanHasError != current.tujuanHasError,
      builder: (context, state) {
        return CardInputTujuan(
          ...
          onChanged: (value) {
            getMemberPaketStreamingProvider(context).setTujuan(value);
          },
          onClear: () {
            getMemberPaketStreamingProvider(
              context,
    ...
    return BlocBuilder<MemberPaketStreamingProvider, MemberPaketStreamingState>(
      ...
      builder: (context, state) {
        return SortFilterProduct(
          ...
          onSearchChanged: (val) {
            getMemberPaketStreamingProvider(context).setSearchProduct(val);
          },
          onClearSearch: () {
            getMemberPaketStreamingProvider(
              context,
          ...
          onSortSelected: (sortBy) {
            getMemberPaketStreamingProvider(context).setSortProduct(sortBy);
          },
        );
      },
    );
        ...
        return RefreshableList(
          ...
          itemBuilder: (context, provider, index) {
            ...
            return CardProductPulsa(
              ...
              isPulsa: true,
              onPress: () {
                getMemberPaketStreamingProvider(context).setSelectedProduct(product);
              },
            );
          },
