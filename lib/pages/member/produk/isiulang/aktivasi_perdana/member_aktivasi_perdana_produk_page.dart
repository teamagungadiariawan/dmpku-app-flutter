...
class MemberAktivasiPerdanaProdukPage extends StatefulWidget {
  static const routeName = '/member/produk/isiulang/aktivasi-perdana/produk';

  const MemberAktivasiPerdanaProdukPage({super.key});

  @override
  State<MemberAktivasiPerdanaProdukPage> createState() =>
      _MemberAktivasiPerdanaProdukPageState();
}

class _MemberAktivasiPerdanaProdukPageState
    extends State<MemberAktivasiPerdanaProdukPage> {
  final shakeKey = GlobalKey<ShakeErrorWidgetState>();

  void closePage() {
    getMemberAktivasiPerdanaProvider(context).resetProduct();
    pop();
  }
  ...
  Widget build(BuildContext context) {
    return AnnotatedRegion<SystemUiOverlayStyle>(
      ...
      child: WillPopScope(
        ...
        child: Scaffold(
          appBar: CustomAppBar(
            title: getMemberAktivasiPerdanaProvider(
              context,
          ...
          bottomNavigationBar:
              BlocBuilder<MemberAktivasiPerdanaProvider, MemberAktivasiPerdanaState>(
    ...
    return BlocBuilder<MemberAktivasiPerdanaProvider, MemberAktivasiPerdanaState>(
      ...
      builder: (context, state) {
        return CardInputTujuan(
          ...
          onChanged: (value) {
            getMemberAktivasiPerdanaProvider(context).setTujuan(value);
          },
          onClear: () {
    ...
    return BlocBuilder<MemberAktivasiPerdanaProvider, MemberAktivasiPerdanaState>(
      ...
      builder: (context, state) {
        return SortFilterProduct(
          ...
          onSearchChanged: (val) {
            getMemberAktivasiPerdanaProvider(context).setSearchProduct(val);
          },
          onClearSearch: () {
            getMemberAktivasiPerdanaProvider(
              context,
          ...
          onSortSelected: (sortBy) {
            getMemberAktivasiPerdanaProvider(context).setSortProduct(sortBy);
          },
        );
      },
    );
        ...
        return RefreshableList(
          ...
          itemBuilder: (context, provider, index) {
            ...
            return CardProductPulsa(
              ...
              isPulsa: true,
              onPress: () {
                getMemberAktivasiPerdanaProvider(context).setSelectedProduct(product);
              },
            );
          },
