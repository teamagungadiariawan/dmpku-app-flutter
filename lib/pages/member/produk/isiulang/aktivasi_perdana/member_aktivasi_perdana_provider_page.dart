...
class MemberAktivasiPerdanaProviderPage extends StatefulWidget {
  static const routeName = '/member/produk/isiulang/aktivasi-perdana/provider';

  const MemberAktivasiPerdanaProviderPage({super.key});

  @override
  State<MemberAktivasiPerdanaProviderPage> createState() =>
      _MemberAktivasiPerdanaProviderPageState();
}

class _MemberAktivasiPerdanaProviderPageState
    extends State<MemberAktivasiPerdanaProviderPage> {
            ...
            children: [
              ...
              Expanded(
                child: TextField(
                  ...
                  onChanged: getMemberAktivasiPerdanaProvider(
                    context,
                  ).setSearchProvider,
