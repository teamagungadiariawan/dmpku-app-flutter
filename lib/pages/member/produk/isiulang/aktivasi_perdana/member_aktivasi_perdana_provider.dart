...
class MemberAktivasiPerdanaState extends Equatable {
  // Provider API
  ...
  const MemberAktivasiPerdanaState({
    // Provider API
  ...
  MemberAktivasiPerdanaState copyWith({
    // Provider API
    ...
    return MemberAktivasiPerdanaState(
      // Provider API
...
class MemberAktivasiPerdanaProvider extends Cubit<MemberAktivasiPerdanaState> {
  ...
  void konfirmasiTrx(BuildContext context) async {
    ...
    >(
      ...
      title:
          'Konfirmasi Transaksi Aktivasi Perdana ${state.selectedProduct.namaproduk}',
      subtitle: 'Masukkan PIN untuk melanjutkan transaksi aktivasi perdana',
  ...
  Future<void> _prosesKonfirmasi(BuildContext context, String pin) async {
    ...
    try {
      ...
      final result = await _produkService.bayarAktivasiPerdanaMember(
  ...
  Future<void> fetchProviders() async {
    ...
    try {
      final result = await _produkService.getAktivasiPerdanaMemberProviders();
      if (!result.status) {
        emit(
          state.copyWith(
      ...
      if (data != null) {
        ...
        emit(
          state.copyWith(
            apiFetchProviderStatus: ApiStatus.failure,
            apiFetchProviderMessage: 'Data provider aktivasi perdana kosong',
          ),
        );
      }
    } on ServerException catch (e) {
  ...
  Future<void> fetchProducts() async {
    ...
    try {
      final result = await _produkService.getAktivasiPerdanaMemberProducts(
      ...
      if (data != null) {
        ...
        emit(
          state.copyWith(
            apiFetchProductStatus: ApiStatus.failure,
            apiFetchProductMessage: 'Data produk aktivasi perdana kosong',
          ),
        );
      }
    } on ServerException catch (e) {
