...
class MemberAktivasiPerdanaKonfirmasiTransaksiPage extends StatefulWidget {
  static const routeName =
      '/member/produk/isiulang/aktivasi_perdana/konfirmasi-transaksi';

  const MemberAktivasiPerdanaKonfirmasiTransaksiPage({super.key});

  @override
  State<MemberAktivasiPerdanaKonfirmasiTransaksiPage> createState() =>
      _MemberAktivasiPerdanaKonfirmasiTransaksiPageState();
}

class _MemberAktivasiPerdanaKonfirmasiTransaksiPageState
    extends State<MemberAktivasiPerdanaKonfirmasiTransaksiPage> {
  void closePage() {
    getMemberAktivasiPerdanaProvider(context).resetKonfirmasi();
    pop();
  }
    ...
    return AnnotatedRegion<SystemUiOverlayStyle>(
      ...
      child: PopScope(
        ...
        child: Scaffold(
          ...
          appBar: CustomAppBar(
            title: 'Konfirmasi Aktivasi Perdana',
  ...
  Widget _buildDetailContent(BuildContext context) {
    return BlocBuilder<MemberAktivasiPerdanaProvider,
                    ...
                    slivers: [
                      ...
                      SliverList(
                        delegate: SliverChildBuilderDelegate((context, index) {
                          final item = state.detailTransaksi.items[index];
                          return _buildDetailItem(context, item);
                        }, childCount: state.detailTransaksi.items.length),
                      ),
                      ...
                      SliverList(
                        delegate: SliverChildBuilderDelegate((context, index) {
                          final item = state.detailPotongStok.items[index];
                          return _buildDetailItem(context, item);
                        }, childCount: state.detailPotongStok.items.length),
                      ),
  ...
  Widget _buildProductInfo(
      BuildContext context, MemberAktivasiPerdanaState state) {
    return Container(
      padding: paddingCard,
      decoration: BoxDecoration(
        color: context.isDarkMode ? slate[600] : slate[200],
      ...
      child: Row(
        children: [
          Image.network(
            state.selectedProduct.imgproduk,
            width: 48,
            height: 48,
          ),
          const Gap(8),
          Expanded(
            child: Column(
              ...
              children: [
                ...
                const Gap(4),
                Text(
                  state.selectedProduct.deskripsiproduk,
          ...
          children: [
            ...
            Column(
              ...
              children: [
                ...
                Text(
                  ToRupiah(state.totalPotongStok.toString()),
            ...
            CustomButton(
              ...
              text: "Lanjutkan",
              onPressed: () {
                getMemberAktivasiPerdanaProvider(context)
                    .konfirmasiTrx(context);
              },
