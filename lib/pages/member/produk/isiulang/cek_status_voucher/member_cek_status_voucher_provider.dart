...
class MemberCekStatusVoucherState extends Equatable {
  // Product API
  ...
  const MemberCekStatusVoucherState({
    // Product API
  ...
  MemberCekStatusVoucherState copyWith({
    // Provider API
    ...
    return MemberCekStatusVoucherState(
      // Product API
...
class MemberCekStatusVoucherProvider
    extends Cubit<MemberCekStatusVoucherState> {
  ...
  Future<void> fetchProducts() async {
    ...
    try {
      final result = await _produkService.getCekStatusVoucherProducts();
      if (!result.status) {
        emit(
          state.copyWith(
  ...
  Future<void> cekStatucVoucher() async {
    ...
    try {
      final result = await _produkService.cekStatusVoucher(
  ...
  void setSelectedProduct(ProductModel product) {
    emit(
      state.copyWith(
        ...
        kodeProdukCek: product.kodeproduk,
      ),
    );
  }
...
MemberCekStatusVoucherProvider getMemberCekStatusVoucherProvider(
  BuildContext context,
) => context.read<MemberCekStatusVoucherProvider>();
