...
class MemberCekStatusVoucherProviderPage extends StatefulWidget {
  ...
  @override
  State<MemberCekStatusVoucherProviderPage> createState() =>
      _MemberCekStatusVoucherProviderPageState();
}

class _MemberCekStatusVoucherProviderPageState
    extends State<MemberCekStatusVoucherProviderPage> {
            ...
            children: [
              ...
              Expanded(
                child: TextField(
                  ...
                  onChanged: getMemberCekStatusVoucherProvider(
                    context,
                  ).setSearchProduct,
