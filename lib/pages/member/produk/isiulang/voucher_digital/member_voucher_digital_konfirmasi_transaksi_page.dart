...
class MemberVoucherDigitalKonfirmasiTransaksiPage extends StatefulWidget {
  static const routeName =
      '/member/produk/isiulang/voucher-digital/konfirmasi-transaksi';

  const MemberVoucherDigitalKonfirmasiTransaksiPage({super.key});

  @override
  State<MemberVoucherDigitalKonfirmasiTransaksiPage> createState() =>
      _MemberVoucherDigitalKonfirmasiTransaksiPageState();
}

class _MemberVoucherDigitalKonfirmasiTransaksiPageState
    extends State<MemberVoucherDigitalKonfirmasiTransaksiPage> {
  void closePage() {
    pop();
  }
  ...
  Widget _buildProductInfo(
      BuildContext context, MemberVoucherDigitalState state) {
    return Container(
      padding: paddingCard,
      decoration: BoxDecoration(
        color: context.isDarkMode ? slate[600] : slate[200],
        ...
        return Row(
          children: [
            ...
            CustomButton(
              ...
              text: "Lanjutkan",
              onPressed: () {
                getMemberVoucherDigitalProvider(context).konfirmasiTrx(context);
              },
