...
class MemberVoucherDigitalProdukPage extends StatefulWidget {
  static const routeName = '/member/produk/isiulang/voucher-digital/produk';

  const MemberVoucherDigitalProdukPage({super.key});

  @override
  State<MemberVoucherDigitalProdukPage> createState() =>
      _MemberVoucherDigitalProdukPageState();
}

class _MemberVoucherDigitalProdukPageState
    extends State<MemberVoucherDigitalProdukPage> {
  final shakeKey = GlobalKey<ShakeErrorWidgetState>();

  void closePage() {
    getMemberVoucherDigitalProvider(context).resetProduct();
    pop();
  }
  ...
  Widget build(BuildContext context) {
    return AnnotatedRegion<SystemUiOverlayStyle>(
      ...
      child: WillPopScope(
        ...
        child: Scaffold(
          appBar: CustomAppBar(
            title: getMemberVoucherDigitalProvider(
              context,
    ...
    return BlocBuilder<MemberVoucherDigitalProvider, MemberVoucherDigitalState>(
      ...
      builder: (context, state) {
        return CardInputTujuan(
          ...
          onChanged: (value) {
            getMemberVoucherDigitalProvider(context).setTujuan(value);
          },
          onClear: () {
            getMemberVoucherDigitalProvider(
              context,
    ...
    return BlocBuilder<MemberVoucherDigitalProvider, MemberVoucherDigitalState>(
      ...
      builder: (context, state) {
        return SortFilterProduct(
          ...
          onSearchChanged: (val) {
            getMemberVoucherDigitalProvider(context).setSearchProduct(val);
          },
          onClearSearch: () {
            getMemberVoucherDigitalProvider(
              context,
          ...
          onSortSelected: (sortBy) {
            getMemberVoucherDigitalProvider(context).setSortProduct(sortBy);
          },
        );
      },
    );
