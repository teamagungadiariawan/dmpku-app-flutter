...
class MemberPaketNelponProdukPage extends StatefulWidget {
  static const routeName = '/member/produk/isiulang/paket_nelpon/produk';
...
class _MemberPaketNelponProdukPageState
  ...
  void closePage() {
    getMemberPaketNelponProvider(context).resetProduct();
    pop();
  }
  ...
  Widget build(BuildContext context) {
    return AnnotatedRegion<SystemUiOverlayStyle>(
      ...
      child: WillPopScope(
        ...
        child: Scaffold(
          appBar: CustomAppBar(
            title: getMemberPaketNelponProvider(
              context,
    ...
    return BlocBuilder<MemberPaketNelponProvider, MemberPaketNelponState>(
      ...
      builder: (context, state) {
        return SortFilterProduct(
          ...
          onSearchChanged: (val) {
            getMemberPaketNelponProvider(context).setSearchProduct(val);
          },
          onClearSearch: () {
            getMemberPaketNelponProvider(
              context,
          ...
          onSortSelected: (sortBy) {
            getMemberPaketNelponProvider(context).setSortProduct(sortBy);
          },
        );
      },
    );
