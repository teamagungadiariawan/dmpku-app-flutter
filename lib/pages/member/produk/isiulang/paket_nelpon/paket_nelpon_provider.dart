...
class MemberPaketNelponState extends Equatable {
  // Provider API
  ...
  MemberPaketNelponState copyWith({
    // Provider API
...
// CUBIT
// ============================================================
class MemberPaketNelponProvider extends Cubit<MemberPaketNelponState> {
  ...
  void konfirmasiTrx(BuildContext context) async {
    ...
    KonfirmasiPinDialog.show<MemberPaketNelponProvider, MemberPaketNelponState>(
      ...
      title:
          'Konfirmasi Transaksi Paket Nelpon ${state.selectedProduct.namaproduk}',
      subtitle: 'Masukkan PIN untuk melanjutkan transaksi paket nelpon',
  ...
  Future<void> _prosesKonfirmasi(BuildContext context, String pin) async {
    ...
    try {
      ...
      final result = await _produkService.bayarPaketNelponMember(
  ...
  Future<void> fetchProviders() async {
    ...
    try {
      final result = await _produkService.getPaketNelponMemberProviders();
      final data = result.data;
      ...
      if (data != null) {
        ...
        emit(
          state.copyWith(
            ...
            apiFetchProviderMessage: 'Data provider paket nelpon kosong',
          ),
        );
      }
    } on ServerException catch (e) {
...
MemberPaketNelponProvider getMemberPaketNelponProvider(BuildContext context) =>
    context.read<MemberPaketNelponProvider>();
