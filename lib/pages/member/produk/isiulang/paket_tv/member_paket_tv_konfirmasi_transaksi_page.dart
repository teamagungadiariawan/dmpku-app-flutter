...
class MemberPaketTvKonfirmasiTransaksiPage extends StatefulWidget {
  static const routeName =
      '/member/produk/isiulang/paket-tv/konfirmasi-transaksi';

  const MemberPaketTvKonfirmasiTransaksiPage({super.key});

  @override
  State<MemberPaketTvKonfirmasiTransaksiPage> createState() =>
      _MemberPaketTvKonfirmasiTransaksiPageState();
}

class _MemberPaketTvKonfirmasiTransaksiPageState
    extends State<MemberPaketTvKonfirmasiTransaksiPage> {
  void closePage() {
    pop();
  }
  ...
  Widget _buildProductInfo(BuildContext context, MemberPaketTvState state) {
    return Container(
      padding: paddingCard,
      decoration: BoxDecoration(
        color: context.isDarkMode ? slate[600] : slate[200],
        ...
        return Row(
          children: [
            ...
            CustomButton(
              ...
              text: "Lanjutkan",
              onPressed: () {
                getMemberPaketTvProvider(context).konfirmasiTrx(context);
              },
