...
class MemberPaketTvProviderPage extends StatefulWidget {
  static const routeName = '/member/produk/isiulang/paket-tv/provider';

  const MemberPaketTvProviderPage({super.key});

  @override
  State<MemberPaketTvProviderPage> createState() =>
            ...
            children: [
              ...
              Expanded(
                child: TextField(
                  ...
                  onChanged: getMemberPaketTvProvider(
                    context,
                  ).setSearchProvider,
