...
class MemberPaketTvState extends Equatable {
  // Provider API
...
class MemberPaketTvProvider extends Cubit<MemberPaketTvState> {
  ...
  Future<void> _prosesKonfirmasi(BuildContext context, String pin) async {
    ...
    try {
      ...
      final result = await _produkService.bayarPaketTVMember(
  ...
  Future<void> fetchProviders() async {
    ...
    try {
      final result = await _produkService.getTVMemberProviders();
      if (!result.status) {
        emit(
          state.copyWith(
      ...
      if (data != null) {
        ...
        emit(
          state.copyWith(
            apiFetchProviderStatus: ApiStatus.failure,
            apiFetchProviderMessage: 'Data provider paket tv kosong',
          ),
        );
      }
    } on ServerException catch (e) {
  ...
  Future<void> fetchProducts() async {
    ...
    try {
      final result = await _produkService.getTVMemberProducts(
      ...
      if (data != null) {
        ...
        emit(
          state.copyWith(
            apiFetchProductStatus: ApiStatus.failure,
            apiFetchProductMessage: 'Data produk paket tv kosong',
          ),
        );
      }
    } on ServerException catch (e) {
...
MemberPaketTvProvider getMemberPaketTvProvider(BuildContext context) =>
    context.read<MemberPaketTvProvider>();