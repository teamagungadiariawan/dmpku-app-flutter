...
class MemberInfoKartuState extends Equatable {
  // Product API
...
class MemberInfoKartuProvider extends Cubit<MemberInfoKartuState> {
  final ProdukService _produkService = ProdukService();

  MemberInfoKartuProvider()
    : super(
        MemberInfoKartuState(
  ...
  Future<void> cekInfoKartu() async {
  ...
  void setSelectedProduct(ProductModel product) {
    emit(state.copyWith(selectedProduct: product,kodeProdukCek: product.kodeproduk));
  }
...
MemberInfoKartuProvider getMemberInfoKartuProvider(BuildContext context) =>
    context.read<MemberInfoKartuProvider>();
