...
class MemberPaketDataKonfirmasiTransaksiPage extends StatefulWidget {
  static const routeName =
      '/member/produk/isiulang/paket_data/konfirmasi-transaksi';
...
class _MemberPaketDataKonfirmasiTransaksiPageState
  ...
  Widget _buildProductInfo(BuildContext context, MemberPaketDataState state) {
    return Container(
      padding: paddingCard,
      decoration: BoxDecoration(
        color: context.isDarkMode ? slate[600] : slate[200],
        ...
        return Row(
          children: [
            ...
            CustomButton(
              ...
              text: "Lanjutkan",
              onPressed: () {
                getMemberPaketDataProvider(context).konfirmasiTrx(context);
              },
