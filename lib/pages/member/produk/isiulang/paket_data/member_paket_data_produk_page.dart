...
class MemberPaketDataProdukPage extends StatefulWidget {
  static const routeName = '/member/produk/isiulang/paket_data/produk';
...
class _MemberPaketDataProdukPageState extends State<MemberPaketDataProdukPage> {
  ...
  void closePage() {
    getMemberPaketDataProvider(context).resetProduct();
    pop();
  }
  ...
  Widget build(BuildContext context) {
    return AnnotatedRegion<SystemUiOverlayStyle>(
      ...
      child: WillPopScope(
        ...
        child: Scaffold(
          appBar: CustomAppBar(
            title: getMemberPaketDataProvider(
              context,
    ...
    return BlocBuilder<MemberPaketDataProvider, MemberPaketDataState>(
      ...
      builder: (context, state) {
        return SortFilterProduct(
          ...
          onSearchChanged: (val) {
            getMemberPaketDataProvider(context).setSearchProduct(val);
          },
          onClearSearch: () {
          ...
          onSortSelected: (sortBy) {
            getMemberPaketDataProvider(context).setSortProduct(sortBy);
          },
        );
      },
    );
        ...
        return RefreshableList(
          ...
          itemBuilder: (context, provider, index) {
            ...
            return CardProductPulsa(
              ...
              isPulsa: true,
              onPress: () {
                getMemberPaketDataProvider(context).setSelectedProduct(product);
              },
            );
          },
