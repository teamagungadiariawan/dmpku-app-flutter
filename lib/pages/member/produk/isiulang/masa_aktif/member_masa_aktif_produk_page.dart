...
import 'package:dmpku/pages/member/produk/isiulang/masa_aktif/masa_aktif_provider.dart';import 'package:dmpku/widgets/card_input_tujuan.dart';
...
class MemberMasaAktifProdukPage extends StatefulWidget {
  static const routeName = '/member/produk/isiulang/masa_aktif/produk';
...
class _MemberMasaAktifProdukPageState extends State<MemberMasaAktifProdukPage> {
  ...
  void closePage() {
    getMemberMasaAktifProvider(context).resetProduct();
    pop();
  }
  ...
  Widget build(BuildContext context) {
    return AnnotatedRegion<SystemUiOverlayStyle>(
      ...
      child: WillPopScope(
        ...
        child: Scaffold(
          appBar: CustomAppBar(
            title: getMemberMasaAktifProvider(
              context,
    ...
    return BlocBuilder<MemberMasaAktifProvider, MemberMasaAktifState>(
      ...
      builder: (context, state) {
        return SortFilterProduct(
          ...
          onSearchChanged: (val) {
            getMemberMasaAktifProvider(context).setSearchProduct(val);
          },
          onClearSearch: () {
          ...
          onSortSelected: (sortBy) {
            getMemberMasaAktifProvider(context).setSortProduct(sortBy);
          },
        );
      },
    );
        ...
        return RefreshableList(
          ...
          itemBuilder: (context, provider, index) {
            ...
            return CardProductPulsa(
              ...
              isPulsa: true,
              onPress: () {
                getMemberMasaAktifProvider(context).setSelectedProduct(product);
              },
            );
          },
