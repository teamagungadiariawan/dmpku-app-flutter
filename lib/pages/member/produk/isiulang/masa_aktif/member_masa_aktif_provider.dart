...
class MemberMasaAktifState extends Equatable {
  // Provider API
...
// CUBIT
// ============================================================
class MemberMasaAktifProvider extends Cubit<MemberMasaAktifState> {
  ...
  Future<void> fetchProviders() async {
    ...
    try {
      final result = await _produkService.getMasaAktifMemberProviders();
      if (!result.status) {
        emit(
          state.copyWith(
      ...
      if (data != null) {
        ...
        emit(
          state.copyWith(
            apiFetchProviderStatus: ApiStatus.failure,
            apiFetchProviderMessage: 'Data provider masa aktif kosong',
          ),
        );
      }
    } on ServerException catch (e) {
  ...
  Future<void> fetchProducts() async {
    ...
    try {
      final result = await _produkService.getMasaAktifMemberProducts(
      ...
      if (data != null) {
        ...
        emit(
          state.copyWith(
            apiFetchProductStatus: ApiStatus.failure,
            apiFetchProductMessage: 'Data produk masa aktif kosong',
          ),
        );
      }
    } on ServerException catch (e) {
  ...
  void setNewKonfirmasi() async {
    ...
    pushNamed(
      MemberMasaAktifKonfirmasiTransaksiPage.routeName,
      arguments: this,
    );
  }
...
MemberMasaAktifProvider getMemberMasaAktifProvider(BuildContext context) =>
    context.read<MemberMasaAktifProvider>();
