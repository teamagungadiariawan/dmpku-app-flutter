...
class MemberVoucherDataState extends Equatable {
  // Provider API
  ...
  MemberVoucherDataState copyWith({
    // Provider API
...
class MemberVoucherDataProvider extends Cubit<MemberVoucherDataState> {
  ...
  void konfirmasiTrx(BuildContext context) async {
    ...
    KonfirmasiPinDialog.show<MemberVoucherDataProvider, MemberVoucherDataState>(
      context,
      // Title & Subtitle default
      title:
          'Konfirmasi Transaksi Voucher Data ${state.selectedProduct.namaproduk}',
  ...
  Future<void> _prosesKonfirmasi(BuildContext context, String pin) async {
    ...
    try {
      ...
      final result = await _produkService.bayarVoucherDataMember(
  ...
  Future<void> fetchProviders() async {
    ...
    try {
      final result = await _produkService.getVoucherDataMemberProviders();
      if (!result.status) {
        emit(
          state.copyWith(
  ...
  Future<void> fetchProducts() async {
    ...
    try {
      final result = await _produkService.getVoucherDataMemberProducts(
...
MemberVoucherDataProvider getMemberVoucherDataProvider(BuildContext context) =>
    context.read<MemberVoucherDataProvider>();
