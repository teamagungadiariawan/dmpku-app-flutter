...
class MemberVoucherDataKonfirmasiTransaksiPage extends StatefulWidget {
  static const routeName =
      '/member/produk/isiulang/voucher-data/konfirmasi-transaksi';

  const MemberVoucherDataKonfirmasiTransaksiPage({super.key});

  @override
  State<MemberVoucherDataKonfirmasiTransaksiPage> createState() =>
      _MemberVoucherDataKonfirmasiTransaksiPageState();
}

class _MemberVoucherDataKonfirmasiTransaksiPageState
    extends State<MemberVoucherDataKonfirmasiTransaksiPage> {
  void closePage() {
    pop();
  }
  ...
  Widget _buildProductInfo(
      BuildContext context, MemberVoucherDataState state) {
    return Container(
      padding: paddingCard,
      decoration: BoxDecoration(
        color: context.isDarkMode ? slate[600] : slate[200],
        ...
        return Row(
          children: [
            ...
            CustomButton(
              ...
              text: "Lanjutkan",
              onPressed: () {
                getMemberVoucherDataProvider(context).konfirmasiTrx(context);
              },
