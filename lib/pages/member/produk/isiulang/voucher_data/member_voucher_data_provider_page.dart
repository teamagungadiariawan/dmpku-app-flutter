...
class MemberVoucherDataProviderPage extends StatefulWidget {
  static const routeName = '/member/produk/isiulang/voucher-data/provider';

  const MemberVoucherDataProviderPage({super.key});

  @override
  State<MemberVoucherDataProviderPage> createState() =>
      _MemberVoucherDataProviderPageState();
}

class _MemberVoucherDataProviderPageState
    extends State<MemberVoucherDataProviderPage> {
  final shakeKey = GlobalKey<ShakeErrorWidgetState>();

  @override
  void dispose() {
    getMemberVoucherDataProvider(context).resetState();
    super.dispose();
  }
        ...
        return RefreshableList(
          ...
          itemBuilder: (context, provider, index) {
            return CardProvider(
              ...
              onPressed: () {
                pushNamed(MemberVoucherDataProdukPage.routeName);
            ...
            children: [
              ...
              Expanded(
                child: TextField(
                  ...
                  onChanged: getMemberVoucherDataProvider(
                    context,
                  ).setSearchProvider,
