          ...
          child: Column(
            ...
            children: [
              ...
              CardProvider(
                ...
                isImgLocal: true,
                onPressed: () {
                  getMemberAktivasiVoucherProvider(context).initMulti();
                  pushNamed(MemberAkitvasiVoucherSatuanPage.routeName);
                },
              ),
              Gap(6),
              CardProvider(
                ...
                isImgLocal: true,
                onPressed: () {
                  pushNamed(MemberAkitvasiVoucherBerurutanPage.routeName);
                },
              ),
            ],
          ),
