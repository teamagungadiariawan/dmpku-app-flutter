...
class MemberAktivasiVoucherKonfirmasiTransaksiPage extends StatefulWidget {
  static const routeName =
      '/member/produk/isiulang/aktivasi-voucher/konfirmasi-transaksi';

  const MemberAktivasiVoucherKonfirmasiTransaksiPage({super.key});

  @override
  State<MemberAktivasiVoucherKonfirmasiTransaksiPage> createState() =>
      _MemberAktivasiVoucherKonfirmasiTransaksiPageState();
}

class _MemberAktivasiVoucherKonfirmasiTransaksiPageState
    extends State<MemberAktivasiVoucherKonfirmasiTransaksiPage> {
  void closePage() {
    pop();
  }
  ...
  Widget _buildProductInfo(BuildContext context, MemberAktivasiVoucherState state) {
    return Container(
      padding: paddingCard,
      decoration: BoxDecoration(
        color: context.isDarkMode ? slate[600] : slate[200],
        ...
        return Row(
          children: [
            ...
            CustomButton(
              ...
              text: "Lanjutkan",
              onPressed: () {
                getMemberAktivasiVoucherProvider(context).konfirmasiTrx(context);
              },
