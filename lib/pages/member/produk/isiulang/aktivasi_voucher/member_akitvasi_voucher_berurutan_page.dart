...
class MemberAkitvasiVoucherBerurutanPage extends StatefulWidget {
  static const routeName = '/member/produk/isiulang/aktivasi-voucher/berurutan';

  const MemberAkitvasiVoucherBerurutanPage({super.key});

  @override
  State<MemberAkitvasiVoucherBerurutanPage> createState() =>
      _MemberAkitvasiVoucherBerurutanPageState();
}

class _MemberAkitvasiVoucherBerurutanPageState
    extends State<MemberAkitvasiVoucherBerurutanPage> {
  final shakeKeyAwal = GlobalKey<ShakeErrorWidgetState>();
  final shakeKeyAkhir = GlobalKey<ShakeErrorWidgetState>();

  void closePage() {
    getMemberAktivasiVoucherProvider(context).resetBerurutan();
    pop();
  }
