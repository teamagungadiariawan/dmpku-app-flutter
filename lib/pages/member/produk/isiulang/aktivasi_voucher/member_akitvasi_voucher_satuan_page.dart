...
import 'member_aktivasi_voucher_provider.dart';
import 'widgets/input_tujuan_voucher.dart';

class MemberAkitvasiVoucherSatuanPage extends StatefulWidget {
  static const routeName = '/member/produk/isiulang/aktivasi-voucher/satuan';

  const MemberAkitvasiVoucherSatuanPage({super.key});

  @override
  State<MemberAkitvasiVoucherSatuanPage> createState() =>
      _MemberAkitvasiVoucherSatuanPageState();
}

class _MemberAkitvasiVoucherSatuanPageState
    extends State<MemberAkitvasiVoucherSatuanPage> {
  void closePage() {
    pop();
  }
  ...
  Widget _buildContinueButton(
    ...
    MemberAktivasiVoucherState state,
  ) {
    ...
    return SizedBox(
      ...
      child: ElevatedButton(
        onPressed: () {
          ...
          var valid = getMemberAktivasiVoucherProvider(
            context,
          ).validateMultiTujuan();
          ...
          getMemberAktivasiVoucherProvider(context).setNewKonfirmasi();
        },
