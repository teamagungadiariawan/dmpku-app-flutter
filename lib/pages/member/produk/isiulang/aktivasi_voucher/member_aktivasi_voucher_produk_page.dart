...
class MemberAktivasiVoucherProdukPage extends StatefulWidget {
  static const routeName = '/member/produk/isiulang/aktivasi-voucher/produk';

  const MemberAktivasiVoucherProdukPage({super.key});

  @override
  State<MemberAktivasiVoucherProdukPage> createState() =>
      _MemberAktivasiVoucherProdukPageState();
}

class _MemberAktivasiVoucherProdukPageState
    extends State<MemberAktivasiVoucherProdukPage> {
  final shakeKey = GlobalKey<ShakeErrorWidgetState>();

  void closePage() {
    getMemberAktivasiVoucherProvider(context).resetProduct();
    pop();
  }

  Future<void> _onRefresh() async {
    getMemberAktivasiVoucherProvider(context).fetchProducts();
  }
  ...
  Widget build(BuildContext context) {
    return AnnotatedRegion<SystemUiOverlayStyle>(
      ...
      child: WillPopScope(
        ...
        child: Scaffold(
          appBar: CustomAppBar(
            title: getMemberAktivasiVoucherProvider(
              context,
          ...
          bottomNavigationBar:
              BlocBuilder<MemberAktivasiVoucherProvider, MemberAktivasiVoucherState>(
    ...
    return BlocBuilder<MemberAktivasiVoucherProvider, MemberAktivasiVoucherState>(
      ...
      builder: (context, state) {
        return SortFilterProduct(
          ...
          onSearchChanged: (val) {
            getMemberAktivasiVoucherProvider(context).setSearchProduct(val);
          },
          onClearSearch: () {
          ...
          onSortSelected: (sortBy) {
            getMemberAktivasiVoucherProvider(context).setSortProduct(sortBy);
          },
        );
      },
    );
        ...
        return RefreshableList(
          ...
          itemBuilder: (context, provider, index) {
            ...
            return CardProductPulsa(
              ...
              isPulsa: true,
              onPress: () {
                getMemberAktivasiVoucherProvider(context).setSelectedProduct(product);
              },
            );
          },
