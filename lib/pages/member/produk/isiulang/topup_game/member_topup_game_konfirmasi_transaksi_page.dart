...
class MemberTopupGameKonfirmasiTransaksiPage extends StatefulWidget {
  static const routeName = '/member/produk/isiulang/topup-game/konfirmasi-transaksi';

  const MemberTopupGameKonfirmasiTransaksiPage({super.key});

  @override
  State<MemberTopupGameKonfirmasiTransaksiPage> createState() =>
      _MemberTopupGameKonfirmasiTransaksiPageState();
}

class _MemberTopupGameKonfirmasiTransaksiPageState
    extends State<MemberTopupGameKonfirmasiTransaksiPage> {
  void closePage() {
    pop();
  }
  ...
  Widget _buildProductInfo(BuildContext context, MemberTopupGameState state) {
    return Container(
      padding: paddingCard,
      decoration: BoxDecoration(
        color: context.isDarkMode ? slate[600] : slate[200],
        ...
        return Row(
          children: [
            ...
            CustomButton(
              ...
              text: "Lanjutkan",
              onPressed: () {
                getMemberTopupGameProvider(context).konfirmasiTrx(context);
              },
