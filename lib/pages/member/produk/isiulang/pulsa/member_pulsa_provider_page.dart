...
class MemberPulsaProviderPage extends StatefulWidget {
  static const routeName = '/member/produk/isiulang/pulsa/provider';

  const MemberPulsaProviderPage({super.key});

  @override
  State<MemberPulsaProviderPage> createState() =>
      _MemberPulsaProviderPageState();
}

class _MemberPulsaProviderPageState extends State<MemberPulsaProviderPage> {
  final shakeKey = GlobalKey<ShakeErrorWidgetState>();

  @override
  void dispose() {
    getMemberPulsaProvider(context).resetState();
    super.dispose();
  }
        ...
        return RefreshableList(
          ...
          itemBuilder: (context, provider, index) {
            return CardProvider(
              ...
              onPressed: () {
                var valid = getMemberPulsaProvider(
                  context,
