...
class MemberPulsaKonfirmasiTransaksiPage extends StatefulWidget {
  static const routeName = '/member/produk/isiulang/pulsa/konfirmasi-transaksi';

  const MemberPulsaKonfirmasiTransaksiPage({super.key});

  @override
  State<MemberPulsaKonfirmasiTransaksiPage> createState() =>
      _MemberPulsaKonfirmasiTransaksiPageState();
}

class _MemberPulsaKonfirmasiTransaksiPageState
    extends State<MemberPulsaKonfirmasiTransaksiPage> {
  void closePage() {
    pop();
  }
  ...
  Widget _buildDetailContent(BuildContext context) {
    return BlocBuilder<MemberPulsaProvider, MemberPulsaState>(
      builder: (context, state) {
        return Expanded(
          child: Container(
  ...
  Widget _buildProductInfo(BuildContext context, MemberPulsaState state) {
    return Container(
      padding: paddingCard,
      decoration: BoxDecoration(
        color: context.isDarkMode ? slate[600] : slate[200],
