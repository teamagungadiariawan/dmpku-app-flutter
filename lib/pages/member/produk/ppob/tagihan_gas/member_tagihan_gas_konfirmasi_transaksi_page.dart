...
class MemberTagihanGasKonfirmasiTransaksiPage extends StatefulWidget {
  static const routeName =
      '/member/produk/ppob/tagihan-gas/konfirmasi-transaksi';

  const MemberTagihanGasKonfirmasiTransaksiPage({super.key});

  @override
  State<MemberTagihanGasKonfirmasiTransaksiPage> createState() =>
      _MemberTagihanGasKonfirmasiTransaksiPageState();
}

class _MemberTagihanGasKonfirmasiTransaksiPageState
    extends State<MemberTagihanGasKonfirmasiTransaksiPage> {
  void closePage() {
    getMemberTagihanGasProvider(context).resetKonfirmasi();
    pop();
  }
    ...
    return AnnotatedRegion<SystemUiOverlayStyle>(
      ...
      child: PopScope(
        ...
        child: Scaffold(
          ...
          appBar: CustomAppBar(
            title: 'Konfirmasi Pembelian Wifi ID',
  ...
  Widget _buildDetailContent(BuildContext context) {
    return BlocBuilder<MemberTagihanGasProvider, MemberTagihanGasState>(
      builder: (context, state) {
        return Expanded(
          child: Container(
  ...
  Widget _buildProductInfo(BuildContext context, MemberTagihanGasState state) {
    return Container(
      padding: paddingCard,
      decoration: BoxDecoration(
        color: context.isDarkMode ? slate[600] : slate[200],
        ...
        return Row(
          children: [
            ...
            CustomButton(
              ...
              text: "Lanjutkan",
              onPressed: () {
                // getMemberTagihanGasProvider(context).konfirmasiTrx(context);
              },
