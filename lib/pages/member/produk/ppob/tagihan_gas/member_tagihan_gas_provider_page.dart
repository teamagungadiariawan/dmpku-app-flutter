...
class MemberTagihanGasProviderPage extends StatefulWidget {
  static const routeName = '/member/produk/ppob/tagihan-gas/provider';

  const MemberTagihanGasProviderPage({super.key});

  @override
  State<MemberTagihanGasProviderPage> createState() =>
      _MemberTagihanGasProviderPageState();
}

class _MemberTagihanGasProviderPageState
    extends State<MemberTagihanGasProviderPage> {
  final shakeKey = GlobalKey<ShakeErrorWidgetState>();

  @override
  void dispose() {
    getMemberTagihanGasProvider(context).resetState();
    super.dispose();
  }
  ...
  Widget build(BuildContext context) {
    return AnnotatedRegion<SystemUiOverlayStyle>(
      ...
      child: WillPopScope(
        ...
        child: Scaffold(
          appBar: CustomAppBar(
            title: "Pilih Provider Tagihan Gas",
            onBackButtonPressed: () {
              closePage();
            },
          ),
        ...
        return RefreshableList(
          ...
          itemBuilder: (context, provider, index) {
            return CardProvider(
              ...
              onPressed: () {
                pushNamed(MemberTagihanGasProdukPage.routeName);
                getMemberTagihanGasProvider(
                  context,
            ...
            children: [
              ...
              Expanded(
                child: TextField(
                  ...
                  onChanged: getMemberTagihanGasProvider(
                    context,
                  ).setSearchProduct,
