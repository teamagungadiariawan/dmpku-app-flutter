...
class MemberECommerceProviderPage extends StatefulWidget {
  static const routeName = '/member/produk/ppob/e-commerce/provider';

  const MemberECommerceProviderPage({super.key});

  @override
  State<MemberECommerceProviderPage> createState() =>
      _MemberECommerceProviderPageState();
}

class _MemberECommerceProviderPageState
    extends State<MemberECommerceProviderPage> {
  final shakeKey = GlobalKey<ShakeErrorWidgetState>();

  @override
  void dispose() {
    getMemberECommerceProvider(context).resetState();
    super.dispose();
  }
  ...
  Widget build(BuildContext context) {
    return AnnotatedRegion<SystemUiOverlayStyle>(
      ...
      child: WillPopScope(
        ...
        child: Scaffold(
          appBar: CustomAppBar(
            title: "Pilih Provider E-Commerce",
            onBackButtonPressed: () {
              closePage();
            },
          ),
        ...
        return RefreshableList(
          ...
          itemBuilder: (context, provider, index) {
            return CardProvider(
              ...
              onPressed: () {
                pushNamed(MemberECommerceProdukPage.routeName);
            ...
            children: [
              ...
              Expanded(
                child: TextField(
                  ...
                  onChanged: getMemberECommerceProvider(
                    context,
                  ).setSearchProduct,
