...
class MemberECommerceKonfirmasiTransaksiPage extends StatefulWidget {
  static const routeName =
      '/member/produk/ppob/e-commerce/konfirmasi-transaksi';

  const MemberECommerceKonfirmasiTransaksiPage({super.key});

  @override
  State<MemberECommerceKonfirmasiTransaksiPage> createState() =>
      _MemberECommerceKonfirmasiTransaksiPageState();
}

class _MemberECommerceKonfirmasiTransaksiPageState
    extends State<MemberECommerceKonfirmasiTransaksiPage> {
  void closePage() {
    getMemberECommerceProvider(context).resetKonfirmasi();
    pop();
  }
  ...
  Widget _buildProductInfo(BuildContext context, MemberECommerceState state) {
    return Container(
      padding: paddingCard,
      decoration: BoxDecoration(
        color: context.isDarkMode ? slate[600] : slate[200],
        ...
        return Row(
          children: [
            ...
            CustomButton(
              ...
              text: "Lanjutkan",
              onPressed: () {
                // getMemberECommerceProvider(context).konfirmasiTrx(context);
              },
