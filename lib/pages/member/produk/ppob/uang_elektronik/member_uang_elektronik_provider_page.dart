...
class MemberUangElektronikProviderPage extends StatefulWidget {
  static const routeName = '/member/produk/ppob/uang-elektronik/provider';

  const MemberUangElektronikProviderPage({super.key});

  @override
  State<MemberUangElektronikProviderPage> createState() =>
      _MemberUangElektronikProviderPageState();
}

class _MemberUangElektronikProviderPageState
    extends State<MemberUangElektronikProviderPage> {
  ...
  Widget build(BuildContext context) {
    return AnnotatedRegion<SystemUiOverlayStyle>(
      ...
      child: WillPopScope(
        ...
        child: Scaffold(
          appBar: CustomAppBar(
            title: "Pilih Provider Uang Elektronik",
            onBackButtonPressed: () {
              closePage();
            },
          ),
            ...
            children: [
              ...
              Expanded(
                child: TextField(
                  ...
                  onChanged: getMemberUangElektronikProvider(
                    context,
                  ).setSearchProvider,
