...
class MemberUangElektronikProdukPage extends StatefulWidget {
  static const routeName = '/member/produk/ppob/uang-elektronik/produk';

  const MemberUangElektronikProdukPage({super.key});

  @override
  State<MemberUangElektronikProdukPage> createState() =>
      _MemberUangElektronikProdukPageState();
}

class _MemberUangElektronikProdukPageState
    extends State<MemberUangElektronikProdukPage> {
  final shakeKey = GlobalKey<ShakeErrorWidgetState>();

  void closePage() {
    getMemberUangElektronikProvider(context).resetProduct();
    pop();
  }
  ...
  Widget build(BuildContext context) {
    return AnnotatedRegion<SystemUiOverlayStyle>(
      ...
      child: WillPopScope(
        ...
        child: Scaffold(
          appBar: CustomAppBar(
            title: getMemberUangElektronikProvider(
              context,
    ...
    return BlocBuilder<MemberUangElektronikProvider, MemberUangElektronikState>(
      ...
      builder: (context, state) {
        return CardInputTujuan(
          ...
          onChanged: (value) {
            getMemberUangElektronikProvider(context).setTujuan(value);
          },
          onClear: () {
            getMemberUangElektronikProvider(
              context,
    ...
    return BlocBuilder<MemberUangElektronikProvider, MemberUangElektronikState>(
      ...
      builder: (context, state) {
        return SortFilterProduct(
          ...
          onSearchChanged: (val) {
            getMemberUangElektronikProvider(context).setSearchProduct(val);
          },
          onClearSearch: () {
            getMemberUangElektronikProvider(
              context,
          ...
          onSortSelected: (sortBy) {
            getMemberUangElektronikProvider(context).setSortProduct(sortBy);
          },
        );
      },
    );
