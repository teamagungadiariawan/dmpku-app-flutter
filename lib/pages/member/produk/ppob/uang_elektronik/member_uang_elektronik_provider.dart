...
class MemberUangElektronikState extends Equatable {
  // Provider API
  ...
  const MemberUangElektronikState({
    // Provider API
  ...
  MemberUangElektronikState copyWith({
    // Provider API
    ...
    return MemberUangElektronikState(
      // Provider API
...
class MemberUangElektronikProvider extends Cubit<MemberUangElektronikState> {
  ...
  void konfirmasiTrx(BuildContext context) async {
    ...
    KonfirmasiPinDialog.show<MemberUangElektronikProvider,
        MemberUangElektronikState>(
      context,
      // Title & Subtitle default
      title:
          'Konfirmasi Transaksi Uang Elektronik ${state.selectedProduct.namaproduk}',
  ...
  Future<void> _prosesKonfirmasi(BuildContext context, String pin) async {
    ...
    try {
      ...
      final result = await _produkService.bayarUangElektronikMember(
  ...
  Future<void> fetchProviders() async {
    ...
    try {
      final result = await _produkService.getUangElektronikMemberProviders();
      if (!result.status) {
        emit(
          state.copyWith(
      ...
      if (data != null) {
        ...
        emit(
          state.copyWith(
            apiFetchProviderStatus: ApiStatus.failure,
            apiFetchProviderMessage: 'Data provider uang elektronik kosong',
          ),
        );
      }
    } on ServerException catch (e) {
  ...
  Future<void> fetchProducts() async {
    ...
    try {
      final result = await _produkService.getUangElektronikMemberProducts(
      ...
      if (data != null) {
        ...
        emit(
          state.copyWith(
            apiFetchProductStatus: ApiStatus.failure,
            apiFetchProductMessage: 'Data produk uang elektronik kosong',
          ),
        );
      }
    } on ServerException catch (e) {
  ...
  void setNewKonfirmasi() async {
    ...
    pushNamed(MemberUangElektronikKonfirmasiTransaksiPage.routeName);
  }
...
MemberUangElektronikProvider getMemberUangElektronikProvider(
        BuildContext context) =>
    context.read<MemberUangElektronikProvider>();