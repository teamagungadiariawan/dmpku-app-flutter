...
class MemberUangElektronikKonfirmasiTransaksiPage extends StatefulWidget {
  static const routeName =
      '/member/produk/ppob/uang-elektronik/konfirmasi-transaksi';

  const MemberUangElektronikKonfirmasiTransaksiPage({super.key});

  @override
  State<MemberUangElektronikKonfirmasiTransaksiPage> createState() =>
      _MemberUangElektronikKonfirmasiTransaksiPageState();
}

class _MemberUangElektronikKonfirmasiTransaksiPageState
    extends State<MemberUangElektronikKonfirmasiTransaksiPage> {
  void closePage() {
    pop();
  }
  ...
  Widget _buildProductInfo(
      BuildContext context, MemberUangElektronikState state) {
    return Container(
      padding: paddingCard,
      decoration: BoxDecoration(
        color: context.isDarkMode ? slate[600] : slate[200],
        ...
        return Row(
          children: [
            ...
            CustomButton(
              ...
              text: "Lanjutkan",
              onPressed: () {
                getMemberUangElektronikProvider(context).konfirmasiTrx(context);
              },
