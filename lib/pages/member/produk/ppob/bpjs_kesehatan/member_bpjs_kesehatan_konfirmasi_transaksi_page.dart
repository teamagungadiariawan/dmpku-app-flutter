...
class MemberBpjsKesehatanKonfirmasiTransaksiPage extends StatefulWidget {
  static const routeName =
      '/member/produk/ppob/bpjs-kesehatan/konfirmasi-transaksi';

  const MemberBpjsKesehatanKonfirmasiTransaksiPage({super.key});

  @override
  State<MemberBpjsKesehatanKonfirmasiTransaksiPage> createState() =>
      _MemberBpjsKesehatanKonfirmasiTransaksiPageState();
}

class _MemberBpjsKesehatanKonfirmasiTransaksiPageState
    extends State<MemberBpjsKesehatanKonfirmasiTransaksiPage> {
  void closePage() {
    getMemberBpjsKesehatanProvider(context).resetKonfirmasi();
    pop();
  }
  ...
  Widget _buildProductInfo(BuildContext context, MemberBpjsKesehatanState state) {
    return Container(
      padding: paddingCard,
      decoration: BoxDecoration(
        color: context.isDarkMode ? slate[600] : slate[200],
        ...
        return Row(
          children: [
            ...
            CustomButton(
              ...
              text: "Lanjutkan",
              onPressed: () {
                getMemberBpjsKesehatanProvider(context).konfirmasiTrx(context);
              },
