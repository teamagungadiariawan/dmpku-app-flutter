...
class MemberBpjsKesehatanProdukPage extends StatefulWidget {
  static const routeName = '/member/produk/ppob/bpjs-kesehatan/produk';

  const MemberBpjsKesehatanProdukPage({super.key});

  @override
  State<MemberBpjsKesehatanProdukPage> createState() =>
      _MemberBpjsKesehatanProdukPageState();
}

class _MemberBpjsKesehatanProdukPageState
    extends State<MemberBpjsKesehatanProdukPage> {
  final _shakeKey = GlobalKey<ShakeErrorWidgetState>();

  MemberBpjsKesehatanProvider get _provider =>
      getMemberBpjsKesehatanProvider(context);
  ...
  Widget _buildTextFieldTujuan(
    ...
    MemberBpjsKesehatanState state,
  ) {
    return Container(
