...
class MemberPdamKonfirmasiTransaksiPage extends StatefulWidget {
  static const routeName =
      '/member/produk/ppob/pdam/konfirmasi-transaksi';

  const MemberPdamKonfirmasiTransaksiPage({super.key});

  @override
  State<MemberPdamKonfirmasiTransaksiPage> createState() =>
      _MemberPdamKonfirmasiTransaksiPageState();
}

class _MemberPdamKonfirmasiTransaksiPageState
    extends State<MemberPdamKonfirmasiTransaksiPage> {
  void closePage() {
    getMemberPdamProvider(context).resetKonfirmasi();
    pop();
  }
  ...
  Widget _buildProductInfo(BuildContext context, MemberPdamState state) {
    return Container(
      padding: paddingCard,
      decoration: BoxDecoration(
        color: context.isDarkMode ? slate[600] : slate[200],
        ...
        return Row(
          children: [
            ...
            CustomButton(
              ...
              text: "Lanjutkan",
              onPressed: () {
                getMemberPdamProvider(context).konfirmasiTrx(context);
              },
