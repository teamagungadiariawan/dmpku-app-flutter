...
class MemberPdamProdukPage extends StatefulWidget {
  static const routeName = '/member/produk/ppob/pdam/produk';
...
class _MemberPdamProdukPageState extends State<MemberPdamProdukPage> {
  ...
  MemberPdamProvider get _provider => getMemberPdamProvider(context);
  ...
  Widget _buildTextFieldTujuan(BuildContext context, MemberPdamState state) {
    return Container(
