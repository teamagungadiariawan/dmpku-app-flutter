...
class MemberHpPascaProdukPage extends StatefulWidget {
  static const routeName = '/member/produk/ppob/hp-pasca/produk';

  const MemberHpPascaProdukPage({super.key});

  @override
  State<MemberHpPascaProdukPage> createState() =>
      _MemberHpPascaProdukPageState();
}

class _MemberHpPascaProdukPageState extends State<MemberHpPascaProdukPage> {
  final _shakeKey = GlobalKey<ShakeErrorWidgetState>();

  MemberHpPascaProvider get _provider => getMemberHpPascaProvider(context);
  ...
  Widget _buildTextFieldTujuan(BuildContext context, MemberHpPascaState state) {
    return Container(
