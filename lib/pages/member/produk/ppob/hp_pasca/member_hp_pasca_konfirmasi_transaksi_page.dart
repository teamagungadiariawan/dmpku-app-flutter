...
class MemberHpPascaKonfirmasiTransaksiPage extends StatefulWidget {
  static const routeName =
      '/member/produk/ppob/hp-pasca/konfirmasi-transaksi';

  const MemberHpPascaKonfirmasiTransaksiPage({super.key});

  @override
  State<MemberHpPascaKonfirmasiTransaksiPage> createState() =>
      _MemberHpPascaKonfirmasiTransaksiPageState();
}

class _MemberHpPascaKonfirmasiTransaksiPageState
    extends State<MemberHpPascaKonfirmasiTransaksiPage> {
  void closePage() {
    getMemberHpPascaProvider(context).resetKonfirmasi();
    pop();
  }
  ...
  Widget _buildProductInfo(BuildContext context, MemberHpPascaState state) {
    return Container(
      padding: paddingCard,
      decoration: BoxDecoration(
        color: context.isDarkMode ? slate[600] : slate[200],
        ...
        return Row(
          children: [
            ...
            CustomButton(
              ...
              text: "Lanjutkan",
              onPressed: () {
                getMemberHpPascaProvider(context).konfirmasiTrx(context);
              },
