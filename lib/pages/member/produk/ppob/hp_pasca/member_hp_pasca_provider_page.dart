...
class MemberHpPascaProviderPage extends StatefulWidget {
  static const routeName = '/member/produk/ppob/hp-pasca/provider';

  const MemberHpPascaProviderPage({super.key});

  @override
  State<MemberHpPascaProviderPage> createState() =>
