...
class MemberESamsatKonfirmasiTransaksiPage extends StatefulWidget {
  static const routeName =
      '/member/produk/ppob/e-samsat/konfirmasi-transaksi';

  const MemberESamsatKonfirmasiTransaksiPage({super.key});

  @override
  State<MemberESamsatKonfirmasiTransaksiPage> createState() =>
      _MemberESamsatKonfirmasiTransaksiPageState();
}

class _MemberESamsatKonfirmasiTransaksiPageState
    extends State<MemberESamsatKonfirmasiTransaksiPage> {
  void closePage() {
    getMemberESamsatProvider(context).resetKonfirmasi();
    pop();
  }
  ...
  Widget _buildProductInfo(BuildContext context, MemberESamsatState state) {
    return Container(
      padding: paddingCard,
      decoration: BoxDecoration(
        color: context.isDarkMode ? slate[600] : slate[200],
        ...
        return Row(
          children: [
            ...
            CustomButton(
              ...
              text: "Lanjutkan",
              onPressed: () {
                getMemberESamsatProvider(context).konfirmasiTrx(context);
              },
