...
class MemberBpjsTknKonfirmasiTransaksiPage extends StatefulWidget {
  static const routeName =
      '/member/produk/ppob/bpjs-tkn/konfirmasi-transaksi';

  const MemberBpjsTknKonfirmasiTransaksiPage({super.key});

  @override
  State<MemberBpjsTknKonfirmasiTransaksiPage> createState() =>
      _MemberBpjsTknKonfirmasiTransaksiPageState();
}

class _MemberBpjsTknKonfirmasiTransaksiPageState
    extends State<MemberBpjsTknKonfirmasiTransaksiPage> {
  void closePage() {
    getMemberBpjsTknProvider(context).resetKonfirmasi();
    pop();
  }
  ...
  Widget _buildDetailContent(BuildContext context) {
    return BlocBuilder<MemberBpjsTknProvider, MemberBpjsTknState>(
      builder: (context, state) {
        return Expanded(
          child: Container(
  ...
  Widget _buildProductInfo(BuildContext context, MemberBpjsTknState state) {
    return Container(
      padding: paddingCard,
      decoration: BoxDecoration(
        color: context.isDarkMode ? slate[600] : slate[200],
