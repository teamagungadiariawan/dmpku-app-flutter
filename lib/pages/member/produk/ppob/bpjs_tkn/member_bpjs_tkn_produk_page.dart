...
class MemberBpjsTknProdukPage extends StatefulWidget {
  static const routeName = '/member/produk/ppob/bpjs-tkn/produk';

  const MemberBpjsTknProdukPage({super.key});

  @override
  State<MemberBpjsTknProdukPage> createState() =>
      _MemberBpjsTknProdukPageState();
}

class _MemberBpjsTknProdukPageState extends State<MemberBpjsTknProdukPage> {
  final _shakeKey = GlobalKey<ShakeErrorWidgetState>();

  MemberBpjsTknProvider get _provider => getMemberBpjsTknProvider(context);
          ...
          child: Padding(
            ...
            child: Column(
              ...
              children: [
                ...
                ButtonFavorit(
                  isGuest: false,
                  tipeProduk: TipeProduk.bpjsKerja,
                  onResult: (val) =>
  ...
  Widget _buildTextFieldTujuan(BuildContext context, MemberBpjsTknState state) {
    return Container(
