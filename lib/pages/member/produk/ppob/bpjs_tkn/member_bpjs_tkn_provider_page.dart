...
class MemberBpjsTknProviderPage extends StatefulWidget {
  static const routeName = '/member/produk/ppob/bpjs-tkn/provider';

  const MemberBpjsTknProviderPage({super.key});

  @override
  State<MemberBpjsTknProviderPage> createState() =>
      _MemberBpjsTknProviderPageState();
}

class _MemberBpjsTknProviderPageState extends State<MemberBpjsTknProviderPage> {
        ...
        return RefreshableList(
          ...
          itemBuilder: (context, provider, index) {
            return CardProvider(
              ...
              onPressed: () {
                pushNamed(
                  MemberBpjsTknProdukPage.routeName,
                  arguments: getMemberBpjsTknProvider(context),
                );
                getMemberBpjsTknProvider(context).setSelectedProduct(provider);
              },
            );
          },
            ...
            children: [
              ...
              Expanded(
                child: TextField(
                  ...
                  onChanged: getMemberBpjsTknProvider(context).setSearchProduct,
