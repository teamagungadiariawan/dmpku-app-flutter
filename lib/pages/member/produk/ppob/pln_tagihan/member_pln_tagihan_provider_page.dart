...
class MemberPlnTagihanProviderPage extends StatefulWidget {
  static const routeName = '/member/produk/ppob/pln-tagihan/provider';

  const MemberPlnTagihanProviderPage({super.key});

  @override
  State<MemberPlnTagihanProviderPage> createState() =>
      _MemberPlnTagihanProviderPageState();
}

class _MemberPlnTagihanProviderPageState
    extends State<MemberPlnTagihanProviderPage> {
  ...
  Widget build(BuildContext context) {
    return AnnotatedRegion<SystemUiOverlayStyle>(
      ...
      child: WillPopScope(
        ...
        child: Scaffold(
          appBar: CustomAppBar(
            title: "Pilih Provider PLN Tagihan",
            onBackButtonPressed: () {
              closePage();
            },
          ),
            ...
            children: [
              ...
              Expanded(
                child: TextField(
                  ...
                  onChanged: getMemberPlnTagihanProvider(
                    context,
                  ).setSearchProduct,
