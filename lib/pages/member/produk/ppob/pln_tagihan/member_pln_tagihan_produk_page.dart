...
class MemberPlnTagihanProdukPage extends StatefulWidget {
  static const routeName = '/member/produk/ppob/pln-tagihan/produk';

  const MemberPlnTagihanProdukPage({super.key});

  @override
  State<MemberPlnTagihanProdukPage> createState() =>
  ...
  Widget _buildIdAkunCard(BuildContext context) {
    return BlocBuilder<MemberPlnTagihanProvider, MemberPlnTagihanState>(
      buildWhen: (previous, current) =>
          ...
          previous.isNontaglist != current.isNontaglist ||
          ...
          child: Padding(
            ...
            child: Column(
              ...
              children: [
                ...
                if (!state.isNontaglist) ...[
                  Gap(8),
                  ButtonFavorit(
                    isGuest: false,
                    tipeProduk: TipeProduk.plnTagihan,
                    onResult: (val) =>
