...
class MemberPlnTagihanKonfirmasiTransaksiPage extends StatefulWidget {
  static const routeName =
      '/member/produk/ppob/pln-tagihan/konfirmasi-transaksi';

  const MemberPlnTagihanKonfirmasiTransaksiPage({super.key});

  @override
  State<MemberPlnTagihanKonfirmasiTransaksiPage> createState() =>
      _MemberPlnTagihanKonfirmasiTransaksiPageState();
}

class _MemberPlnTagihanKonfirmasiTransaksiPageState
    extends State<MemberPlnTagihanKonfirmasiTransaksiPage> {
  void closePage() {
    getMemberPlnTagihanProvider(context).resetKonfirmasi();
    pop();
  }
  ...
  Widget _buildProductInfo(BuildContext context, MemberPlnTagihanState state) {
    return Container(
      padding: paddingCard,
      decoration: BoxDecoration(
        color: context.isDarkMode ? slate[600] : slate[200],
        ...
        return Row(
          children: [
            ...
            CustomButton(
              ...
              text: "Lanjutkan",
              onPressed: () {
                getMemberPlnTagihanProvider(context).konfirmasiTrx(context);
              },
