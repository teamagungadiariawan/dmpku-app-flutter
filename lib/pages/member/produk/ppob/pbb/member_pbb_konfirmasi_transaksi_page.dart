...
class MemberPbbKonfirmasiTransaksiPage extends StatefulWidget {
  static const routeName =
      '/member/produk/ppob/pbb/konfirmasi-transaksi';

  const MemberPbbKonfirmasiTransaksiPage({super.key});

  @override
  State<MemberPbbKonfirmasiTransaksiPage> createState() =>
      _MemberPbbKonfirmasiTransaksiPageState();
}

class _MemberPbbKonfirmasiTransaksiPageState
    extends State<MemberPbbKonfirmasiTransaksiPage> {
  void closePage() {
    getMemberPbbProvider(context).resetKonfirmasi();
    pop();
  }
  ...
  Widget _buildProductInfo(BuildContext context, MemberPbbState state) {
    return Container(
      padding: paddingCard,
      decoration: BoxDecoration(
        color: context.isDarkMode ? slate[600] : slate[200],
        ...
        return Row(
          children: [
            ...
            CustomButton(
              ...
              text: "Lanjutkan",
              onPressed: () {
                // getMemberPbbProvider(context).konfirmasiTrx(context);
              },
