...
class MemberInternetTvState extends Equatable {
  // Product API
  ...
  MemberInternetTvState copyWith({
    // Product API
...
class MemberInternetTvProvider extends Cubit<MemberInternetTvState> {
  final ProdukService _produkService = ProdukService();

  MemberInternetTvProvider()
    : super(
        MemberInternetTvState(
  ...
  void konfirmasiTrx(BuildContext context) async {
    ...
    KonfirmasiPinDialog.show<MemberInternetTvProvider, MemberInternetTvState>(
      context,
  ...
  Future<void> _prosesKonfirmasi(BuildContext context, String pin) async {
    ...
    try {
      ...
      final result = await _produkService.bayarInternetTv(
  ...
  Future<void> fetchProducts() async {
    ...
    try {
      final result = await _produkService.getInternetTvProducts();
      if (!result.status) {
        emit(
          state.copyWith(
  ...
  Future<void> cekTagihan(BuildContext context) async {
    ...
    try {
      final result = await _produkService.cekInternetTv(
        kodeproduk: state.selectedProduct.kodeproduk,
        tujuan: state.tujuan,
      );
  ...
  void kelolaCekTagihan(BuildContext context, CekTagihanResponse response) {
    if (response.status) {
      if (response.dataSplit != null) {
        ...
        pushNamed(MemberInternetTvKonfirmasiTransaksiPage.routeName);
      }
    } else {
      List<KeyValue> dataTransaksi = response.dataSplit?.dataTransaksi ?? [];
      dataTransaksi = dataTransaksi
...
MemberInternetTvProvider getMemberInternetTvProvider(BuildContext context) =>
    context.read<MemberInternetTvProvider>();
