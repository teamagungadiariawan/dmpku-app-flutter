...
class MemberInternetTvKonfirmasiTransaksiPage extends StatefulWidget {
  static const routeName =
      '/member/produk/ppob/internet-tv/konfirmasi-transaksi';

  const MemberInternetTvKonfirmasiTransaksiPage({super.key});

  @override
  State<MemberInternetTvKonfirmasiTransaksiPage> createState() =>
      _MemberInternetTvKonfirmasiTransaksiPageState();
}

class _MemberInternetTvKonfirmasiTransaksiPageState
    extends State<MemberInternetTvKonfirmasiTransaksiPage> {
  void closePage() {
    getMemberInternetTvProvider(context).resetKonfirmasi();
    pop();
  }
  ...
  Widget _buildProductInfo(BuildContext context, MemberInternetTvState state) {
    return Container(
      padding: paddingCard,
      decoration: BoxDecoration(
        color: context.isDarkMode ? slate[600] : slate[200],
        ...
        return Row(
          children: [
            ...
            CustomButton(
              ...
              text: "Lanjutkan",
              onPressed: () {
                getMemberInternetTvProvider(context).konfirmasiTrx(context);
              },
