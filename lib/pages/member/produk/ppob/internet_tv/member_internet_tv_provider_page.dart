...
class MemberInternetTvProviderPage extends StatefulWidget {
  static const routeName = '/member/produk/ppob/internet-tv/provider';

  const MemberInternetTvProviderPage({super.key});

  @override
  State<MemberInternetTvProviderPage> createState() =>
      _MemberInternetTvProviderPageState();
}

class _MemberInternetTvProviderPageState
    extends State<MemberInternetTvProviderPage> {
  final shakeKey = GlobalKey<ShakeErrorWidgetState>();

  @override
  void dispose() {
    getMemberInternetTvProvider(context).resetState();
    super.dispose();
  }
  ...
  Widget build(BuildContext context) {
    return AnnotatedRegion<SystemUiOverlayStyle>(
      ...
      child: WillPopScope(
        ...
        child: Scaffold(
          appBar: CustomAppBar(
            title: "Pilih Provider Internet & TV",
            onBackButtonPressed: () {
              closePage();
            },
          ),
        ...
        return RefreshableList(
          ...
          itemBuilder: (context, provider, index) {
            return CardProvider(
              ...
              onPressed: () {
                pushNamed(MemberInternetTvProdukPage.routeName);
            ...
            children: [
              ...
              Expanded(
                child: TextField(
                  ...
                  onChanged: getMemberInternetTvProvider(
                    context,
                  ).setSearchProduct,
