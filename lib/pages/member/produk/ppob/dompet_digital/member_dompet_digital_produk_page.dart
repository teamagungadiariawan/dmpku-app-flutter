...
class MemberDompetDigitalProdukPage extends StatefulWidget {
  ...
  const MemberDompetDigitalProdukPage({super.key});

  @override
  State<MemberDompetDigitalProdukPage> createState() =>
...
class _MemberDompetDigitalProdukPageState extends State<MemberDompetDigitalProdukPage> {
  ...
  Widget _buildBottomBar() {
    return BlocProvider.value(
      value: _provider,
      child: BlocBuilder<MemberDompetDigitalProvider, MemberDompetDigitalState>(
        buildWhen: (prev, curr) =>
        ...
        return Column(
          ...
          children: [
            if (state.isCekAkun)
              ButtonCekAkun(
                onPressed: () {
                  getMemberDompetDigitalProvider(context).cekAkun();
                },
