...
class MemberDompetDigitalNominalBebasKonfirmasiTransaksiPage extends StatefulWidget {
  static const routeName =
      '/member/produk/ppob/dompet-digital/konfirmasi-transaksi-nominal-bebas';

  const MemberDompetDigitalNominalBebasKonfirmasiTransaksiPage({super.key});

  @override
  State<MemberDompetDigitalNominalBebasKonfirmasiTransaksiPage> createState() =>
      _MemberDompetDigitalNominalBebasKonfirmasiTransaksiPageState();
}

class _MemberDompetDigitalNominalBebasKonfirmasiTransaksiPageState
    extends State<MemberDompetDigitalNominalBebasKonfirmasiTransaksiPage> {
  void closePage() {
    pop();
  }
  ...
  Widget _buildProductInfo(
      BuildContext context, MemberDompetDigitalState state) {
    return Container(
      padding: paddingCard,
      decoration: BoxDecoration(
        color: context.isDarkMode ? slate[600] : slate[200],
        ...
        return Row(
          children: [
            ...
            CustomButton(
              ...
              text: "Lanjutkan",
              onPressed: () {
                getMemberDompetDigitalProvider(context).konfirmasiTrxNominalBebas(context);
              },
