...
class MemberDompetDigitalKonfirmasiTransaksiPage extends StatefulWidget {
  static const routeName =
      '/member/produk/ppob/dompet-digital/konfirmasi-transaksi';

  const MemberDompetDigitalKonfirmasiTransaksiPage({super.key});

  @override
  State<MemberDompetDigitalKonfirmasiTransaksiPage> createState() =>
      _MemberDompetDigitalKonfirmasiTransaksiPageState();
}

class _MemberDompetDigitalKonfirmasiTransaksiPageState
    extends State<MemberDompetDigitalKonfirmasiTransaksiPage> {
  void closePage() {
    pop();
  }
        ...
        return Row(
          children: [
            ...
            CustomButton(
              ...
              text: "Lanjutkan",
              onPressed: () {
                getMemberDompetDigitalProvider(context).konfirmasiTrx(context);
              },
