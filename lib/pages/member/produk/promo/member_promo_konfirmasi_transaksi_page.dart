...
class MemberPromoKonfirmasiTransaksiPage extends StatefulWidget {
  static const routeName = '/member/produk/promo/konfirmasi-transaksi';

  const MemberPromoKonfirmasiTransaksiPage({super.key});

  @override
  State<MemberPromoKonfirmasiTransaksiPage> createState() =>
      _MemberPromoKonfirmasiTransaksiPageState();
}

class _MemberPromoKonfirmasiTransaksiPageState
    extends State<MemberPromoKonfirmasiTransaksiPage> {
  void closePage() {
    pop();
  }
  ...
  Widget _buildDetailContent(BuildContext context) {
    return BlocBuilder<MemberPromoProvider, MemberPromoState>(
      builder: (context, state) {
        final detailTransaksi = state.detailTransaksi.items;
        final detailPotongStok = state.detailPotongStok.items;
        final totalPotongStok = state.totalPotongStok;
  ...
  Widget _buildProductInfo(BuildContext context, MemberPromoState state) {
    return Container(
      padding: paddingCard,
      decoration: BoxDecoration(
        color: context.isDarkMode ? slate[600] : slate[200],
          ...
          children: [
            ...
            Column(
              ...
              children: [
                ...
                Text(
                  ToRupiah(totalPotongStok.toString()),
            ...
            CustomButton(
              ...
              text: "Lanjutkan",
              onPressed: () {
                getMemberPromoProvider(context).konfirmasiTrx(context);
              },
