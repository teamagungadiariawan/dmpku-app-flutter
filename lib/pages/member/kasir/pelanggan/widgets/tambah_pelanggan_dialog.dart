...
class TambahPelangganDialog extends StatefulWidget {
  const TambahPelangganDialog({super.key});
    ...
    showModalBottomSheet(
      ...
      builder: (_) {
        return BlocProvider.value(
          ...
          child: const TambahPelangganDialog(),
        );
      },
    );
  }
...
class _TambahPelangganDialogState extends State<TambahPelangganDialog> {
  ...
  void simpanPelanggan() {
    if (validateTambahPelanggan()) {
      final nama = _namaController.text.trim();
      final noHp = _noHpController.text.trim();
      final alamat = _alamatController.text.trim();

      context.read<MemberPelangganProvider>().tambahPelanggan(
        context,
        namaPelanggan: nama,
        noHp: noHp,
        alamat: alamat,
  ...
  Widget build(BuildContext context) {
    ...
    return BlocListener<MemberPelangganProvider, MemberPelangganState>(
      listenWhen: (prev, curr) =>
          prev.apiTambahPelangganStatus != curr.apiTambahPelangganStatus,
      listener: (context, state) {
        if (state.apiTambahPelangganStatus == ApiStatus.success) {
          pop();
        }
      },
      child: SafeArea(
                    ...
                    child: Row(
                      children: [
                        Container(
                          ...
                          child: Icon(MdiIcons.accountPlus, size: 16),
                        ),
                        const Gap(10),
                        Expanded(
                          child: Column(
                            ...
                            children: [
                              ...
                              Text(
                                'Tambahkan pelanggan baru ke daftar Anda.',
                  ...
                  builder: (context, state) {
                    return Padding(
                      ...
                      child: CustomButton(
                        ...
                        isLoading: state.apiTambahPelangganStatus.isLoading,
