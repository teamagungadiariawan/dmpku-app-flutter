...
class UbahProdukDialog extends StatefulWidget {
  final ProdukModel produkModel;

  const UbahProdukDialog({super.key, required this.produkModel});
    ...
    showModalBottomSheet(
      ...
      builder: (_) {
        return BlocProvider.value(
          ...
          child: UbahProdukDialog(produkModel: produkModel),
        );
      },
    );
  }
  ...
  @override
  State<UbahProdukDialog> createState() => _UbahProdukDialogState();
}

class _UbahProdukDialogState extends State<UbahProdukDialog> {
  ...
  final shakeKeySatuan = GlobalKey<ShakeWidgetState>();
  ...
  void initState() {
    ...
    _namaController = TextEditingController(
      text: widget.produkModel.namaproduk,
    );
    _hargaModalController = TextEditingController(
      text: ToCurrency(widget.produkModel.hargamodal.toString()),
    );
    _hargaJualController = TextEditingController(
      text: ToCurrency(widget.produkModel.hargajual.toString()),
    );
    _satuanController = TextEditingController(text: widget.produkModel.satuan);
  }
  ...
  bool validateUbahProduk() {
    ...
    setState(() {
      ...
      if (_satuanController.text.isEmpty) {
        errorSatuan = 'Satuan wajib diisi';
        isValid = false;
      }
    });
    ...
    if (!isValid) {
      ...
      if (errorSatuan.isNotEmpty) shakeKeySatuan.currentState?.shake();
    }
  ...
  void simpanProduk() {
    if (validateUbahProduk()) {
      ...
      context.read<MemberProdukProvider>().ubahProduk(
        context,
  ...
  Widget build(BuildContext context) {
    ...
    return BlocListener<MemberProdukProvider, MemberProdukState>(
      listenWhen: (prev, curr) =>
          prev.apiUbahProdukStatus != curr.apiUbahProdukStatus,
      listener: (context, state) {
        if (state.apiUbahProdukStatus == ApiStatus.success) {
          pop();
        }
      },
      child: SafeArea(
              ...
              children: [
                    ...
                    child: Row(
                      children: [
                        Container(
                          ...
                          child: Icon(MdiIcons.packageVariant, size: 16),
                        ),
                        const Gap(10),
                        Expanded(
                          child: Column(
                ...
                Padding(
                  ...
                  child: _buildTextField(
                    ...
                    shakeKey: shakeKeySatuan,
                    errorText: errorSatuan,
                  ),
                ),
                const Gap(20),
                  ...
                  builder: (context, state) {
                    return Padding(
                      ...
                      child: CustomButton(
                        ...
                        isLoading: state.apiUbahProdukStatus.isLoading,
