...
class BuatTiketQrisPage extends StatefulWidget {
  static const routeName = '/member/isistok/qris/buat_tiket';

  const BuatTiketQrisPage({super.key});

  @override
  State<BuatTiketQrisPage> createState() => _BuatTiketQrisPageState();
}

class _BuatTiketQrisPageState extends State<BuatTiketQrisPage> {
              ...
              return CustomButton(
                ...
                onPressed: () async {
                  ...
                  final success = await getMemberIsiStokProvider(
                    context,
                  ).buatTiketQris(nominal: nominal);
                },
                isLoading: state.apiBuatQrisStatus.isLoading,
              );
            },
          ),
        ),
                            ...
                            Expanded(
                              child: Column(
                                ...
                                children: [
                                  ...
                                  Gap(4),
                                  Text(
                                    "Metode pembayaran QRIS akan dikenakan biaya admin sebesar 0.7% dari nominal deposit.",
