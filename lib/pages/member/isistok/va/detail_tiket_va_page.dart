...
class _DetailTiketVaPageState extends State<DetailTiketVaPage> {
        ...
        child: Scaffold(
          body: BlocBuilder<MemberIsiStokProvider, MemberIsiStokState>(
            builder: (context, state) {
              final tiket = state.selectedRiwayatVa;
              return Stack(
                children: [
                  ...
                  Padding(
                    ...
                    child: Column(
                      children: [
                        ...
                        _buildVaNumberCard(context, tiket),
                        const Gap(5),
                        Expanded(
                          child: ListView(
  ...
  Widget _buildVaNumberCard(BuildContext context, RiwayatTiketVAModel tiket) {
    return Card(
      child: Padding(
            ...
            Row(
              ...
              children: [
                ...
                CustomButton(
                  ...
                  onPressed: () {
                    Clipboard.setData(ClipboardData(text: tiket.nova));
            ...
            Container(
              ...
              child: Row(
                ...
                children: [
                  ...
                  Expanded(
                    child: Text(
                      "Lakukan transfer ke nomor Virtual Account di atas.",
  ...
  Widget _buildRincianCard(BuildContext context, RiwayatTiketVAModel tiket) {
    return Card(
      child: Column(
        children: [
          Container(
