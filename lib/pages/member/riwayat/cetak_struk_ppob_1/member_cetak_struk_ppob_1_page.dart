...
class MemberCetakStrukPpob1Page extends StatefulWidget {
  ...
  const MemberCetakStrukPpob1Page({Key? key}) : super(key: key);

  @override
  _MemberCetakStrukPpob1PageState createState() =>
      _MemberCetakStrukPpob1PageState();
}

class _MemberCetakStrukPpob1PageState extends State<MemberCetakStrukPpob1Page> {
  ...
  void openAturHargaDialog() async {
    ...
    final state = getMemberCetakStrukPpob1Provider(context).state;
    AturHargaPpob1Dialog.show(context, initialBiayaJasa: state.biayaJasa);
  }
                    ...
                    AturInfoKiosDialog.show(
                      ...
                      onSave:
                          (
                            ...
                            getMemberCetakStrukPpob1Provider(
                              context,
                            ).reloadKiosInfo();
                          },
                    );
