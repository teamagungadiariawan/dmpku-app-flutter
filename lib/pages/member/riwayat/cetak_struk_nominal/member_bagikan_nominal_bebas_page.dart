...
class BagikanNominalBebasPage extends StatefulWidget {
  static const routeName = '/member/riwayat/bagikan-struk-nominal_bebas';

  const BagikanNominalBebasPage({super.key});

  @override
  State<BagikanNominalBebasPage> createState() =>
      _BagikanNominalBebasPageState();
}

class _BagikanNominalBebasPageState extends State<BagikanNominalBebasPage> {
  ...
  Future<void> _handleShareFullPage(
    ...
    final myBloc = context.read<MemberCetakStrukNominalBebasProvider>();
