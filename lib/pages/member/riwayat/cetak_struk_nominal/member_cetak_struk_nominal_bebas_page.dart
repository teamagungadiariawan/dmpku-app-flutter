...
import 'package:dmpku/pages/member/riwayat/cetak_struk_nominal/widgets/atur_harga_nominal_bebas_dialog.dart';
...
import 'member_cetak_struk_nominal_bebas_provider.dart';
import 'dart:io';
import 'dart:typed_data';
import 'package:path_provider/path_provider.dart';
import 'package:share_plus/share_plus.dart';

class CetakStrukNominalBebasPage extends StatefulWidget {
  static const routeName = '/member/riwayat/cetak-struk-nominal_bebas';

  const CetakStrukNominalBebasPage({super.key});

  @override
  State<CetakStrukNominalBebasPage> createState() =>
      _CetakStrukNominalBebasPageState();
}

class _CetakStrukNominalBebasPageState
    extends State<CetakStrukNominalBebasPage> {
  ...
  void closePage() {
    getMemberCetakStrukNominalBebasProvider(context).resetState();
    pop();
  }
  ...
  void openAturHargaDialog() async {
    ...
    final state = getMemberCetakStrukNominalBebasProvider(context).state;
    AturHargaNominalBebasDialog.show(
      context,
  ...
  Widget _buildFooterSection(
    ...
    MemberCetakStrukNominalBebasState state,
  ) {
    return Container(
      padding: paddingPage,
      child: Column(
                    ...
                    AturInfoKiosDialog.show(
                      ...
                      onSave:
                          (
                            ...
                            getMemberCetakStrukNominalBebasProvider(
                              context,
                            ).reloadKiosInfo();
                          },
                    );
