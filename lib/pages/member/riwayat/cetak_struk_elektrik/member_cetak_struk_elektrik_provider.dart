...
class MemberCetakStrukElektrikState extends Equatable {
  ...
  const MemberCetakStrukElektrikState({
    this.dataTrx = const [],
  ...
  MemberCetakStrukElektrikState copyWith({
    ...
    return MemberCetakStrukElektrikState(
...
class MemberCetakStrukElektrikProvider
    extends Cubit<MemberCetakStrukElektrikState> {
...
MemberCetakStrukElektrikProvider getMemberCetakStrukElektrikProvider(
  BuildContext context,
) => context.read<MemberCetakStrukElektrikProvider>();
