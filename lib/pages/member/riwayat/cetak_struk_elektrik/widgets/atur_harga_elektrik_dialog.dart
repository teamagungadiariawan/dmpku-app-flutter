...
class AturHargaElektrikDialog extends StatefulWidget {
  static const routeName =
      '/member/riwayat/cetak_struk_elektrik/atur_harga_elektrik_dialog';

  final int initialHarga;
  final int initialAdmin;

  const AturHargaElektrikDialog({
    super.key,
  ...
  static Future<void> show(
    ...
    return showModalBottomSheet(
      ...
      useSafeArea: true,
      builder: (context) => AturHargaElektrikDialog(
  ...
  @override
  State<AturHargaElektrikDialog> createState() =>
      _AturHargaElektrikDialogState();
}

class _AturHargaElektrikDialogState extends State<AturHargaElektrikDialog> {
