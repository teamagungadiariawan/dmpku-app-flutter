...
// 1. Tambah import ini di atas
import 'package:screenshot/screenshot.dart';
import 'package:path_provider/path_provider.dart';
import 'package:share_plus/share_plus.dart';
import 'dart:io';

class BagikanElektrikPage extends StatefulWidget {
  static const routeName = '/member/riwayat/bagikan-struk-elektrik';

  const BagikanElektrikPage({super.key});

  @override
  State<BagikanElektrikPage> createState() => _BagikanElektrikPageState();
}

class _BagikanElektrikPageState extends State<BagikanElektrikPage> {
  ...
  Future<void> _handleShareFullPage(
    ...
    final myBloc = context.read<MemberCetakStrukElektrikProvider>();
