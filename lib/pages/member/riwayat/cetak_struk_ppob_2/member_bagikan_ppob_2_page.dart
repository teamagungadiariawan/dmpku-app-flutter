...
class BagikanPpob2Page extends StatefulWidget {
  static const routeName = '/member/riwayat/bagikan-struk-ppob_2';

  const BagikanPpob2Page({super.key});

  @override
  State<BagikanPpob2Page> createState() => _BagikanPpob2PageState();
}

class _BagikanPpob2PageState extends State<BagikanPpob2Page> {
  ...
  Future<void> _handleShareFullPage(
    ...
    final myBloc = context.read<MemberCetakStrukPpob2Provider>();
