...
class MemberOfficialPage extends StatefulWidget {
  const MemberOfficialPage({super.key});

  @override
  State<MemberOfficialPage> createState() => _MemberOfficialPageState();
}

class _MemberOfficialPageState extends State<MemberOfficialPage> {
  // --------------------------------------------------------------------------
  // Data
  // --------------------------------------------------------------------------
