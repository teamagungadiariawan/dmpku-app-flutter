...
class VoucherDigitalState extends Equatable {
  // Provider API
...
class VoucherDigitalProvider extends Cubit<VoucherDigitalState> {
  final ProdukService _produkService = ProdukService();

  VoucherDigitalProvider()
    : super(
        VoucherDigitalState(
  ...
  Future<void> fetchProviders() async {
    ...
    try {
      final result = await _produkService.getVoucherDigitalGuestProviders();
  ...
  Future<void> fetchProducts() async {
    ...
    try {
      final result = await _produkService.getVoucherDigitalGuestProducts(
...
VoucherDigitalProvider getVoucherDigitalProvider(BuildContext context) =>
    context.read<VoucherDigitalProvider>();
