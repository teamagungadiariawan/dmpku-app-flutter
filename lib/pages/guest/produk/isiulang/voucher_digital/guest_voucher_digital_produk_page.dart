...
class GuestVoucherDigitalProdukPage extends StatefulWidget {
  static const routeName = '/guest/produk/isiulang/voucher-digital/produk';

  const GuestVoucherDigitalProdukPage({super.key});

  @override
  State<GuestVoucherDigitalProdukPage> createState() =>
      _GuestVoucherDigitalProdukPageState();
}

class _GuestVoucherDigitalProdukPageState
    extends State<GuestVoucherDigitalProdukPage> {
  ...
  Widget build(BuildContext context) {
    return AnnotatedRegion<SystemUiOverlayStyle>(
      ...
      child: WillPopScope(
        ...
        child: Scaffold(
          appBar: CustomAppBar(
            title: getVoucherDigitalProvider(
              context,
          ...
          bottomNavigationBar:
              BlocBuilder<VoucherDigitalProvider, VoucherDigitalState>(
    ...
    return BlocBuilder<VoucherDigitalProvider, VoucherDigitalState>(
      ...
      builder: (context, state) {
        return CardInputTujuan(
          ...
          onChanged: (value) {
            getVoucherDigitalProvider(context).setTujuan(value);
          },
          onClear: () {
    ...
    return BlocBuilder<VoucherDigitalProvider, VoucherDigitalState>(
      ...
      builder: (context, state) {
        return SortFilterProduct(
          ...
          onSearchChanged: (val) {
            getVoucherDigitalProvider(context).setSearchProduct(val);
          },
          onClearSearch: () {
            getVoucherDigitalProvider(
              context,
          ...
          onSortSelected: (sortBy) {
            getVoucherDigitalProvider(context).setSortProduct(sortBy);
          },
        );
      },
    );
        ...
        return RefreshableList(
          ...
          itemBuilder: (context, provider, index) {
            ...
            return CardProductPulsa(
              ...
              isPulsa: true,
              onPress: () {
                getVoucherDigitalProvider(context).setSelectedProduct(product);
              },
            );
          },
