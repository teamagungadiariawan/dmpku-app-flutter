...
class GuestPaketDataProdukPage extends StatefulWidget {
  static const routeName = '/guest/produk/isiulang/paket-data/produk';

  const GuestPaketDataProdukPage({super.key});

  @override
  State<GuestPaketDataProdukPage> createState() =>
      _GuestPaketDataProdukPageState();
}

class _GuestPaketDataProdukPageState extends State<GuestPaketDataProdukPage> {
  ...
  Future<void> _onRefresh() async {
    getPaketDataProvider(context).fetchProducts();
  }
    ...
    return BlocBuilder<PaketDataProvider, PaketDataState>(
      ...
      builder: (context, state) {
        return CardInputTujuan(
          ...
          onClear: () {
            getPaketDataProvider(context).setTujuan('', updateController: true);
          },
          shakeKey: shakeKey,
        ...
        return RefreshableList(
          ...
          itemBuilder: (context, provider, index) {
            ...
            return CardProductPulsa(
              ...
              isPulsa: true,
              onPress: () {
                getPaketDataProvider(context).setSelectedProduct(product);
              },
            );
          },
