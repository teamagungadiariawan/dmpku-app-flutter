...
class GuestPaketStreamingProviderPage extends StatefulWidget {
  static const routeName = '/guest/produk/isiulang/paket-streaming/provider';

  const GuestPaketStreamingProviderPage({super.key});

  @override
  State<GuestPaketStreamingProviderPage> createState() =>
      _GuestPaketStreamingProviderPageState();
}

class _GuestPaketStreamingProviderPageState
    extends State<GuestPaketStreamingProviderPage> {
            ...
            children: [
              ...
              Expanded(
                child: TextField(
                  ...
                  onChanged: getPaketStreamingProvider(
                    context,
                  ).setSearchProvider,
