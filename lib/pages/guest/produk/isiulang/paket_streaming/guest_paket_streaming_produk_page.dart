...
class GuestPaketStreamingProdukPage extends StatefulWidget {
  static const routeName = '/guest/produk/isiulang/paket-streaming/produk';

  const GuestPaketStreamingProdukPage({super.key});

  @override
  State<GuestPaketStreamingProdukPage> createState() =>
      _GuestPaketStreamingProdukPageState();
}

class _GuestPaketStreamingProdukPageState
    extends State<GuestPaketStreamingProdukPage> {
  ...
  Future<void> _onRefresh() async {
    getPaketStreamingProvider(context).fetchProducts();
  }
  ...
  Widget build(BuildContext context) {
    return AnnotatedRegion<SystemUiOverlayStyle>(
      ...
      child: WillPopScope(
        ...
        child: Scaffold(
          appBar: CustomAppBar(
            title: getPaketStreamingProvider(
              context,
          ...
          bottomNavigationBar:
              BlocBuilder<PaketStreamingProvider, PaketStreamingState>(
    ...
    return BlocBuilder<PaketStreamingProvider, PaketStreamingState>(
      ...
      builder: (context, state) {
        return CardInputTujuan(
          ...
          onChanged: (value) {
            getPaketStreamingProvider(context).setTujuan(value);
          },
          onClear: () {
    ...
    return BlocBuilder<PaketStreamingProvider, PaketStreamingState>(
      ...
      builder: (context, state) {
        return SortFilterProduct(
          ...
          onSearchChanged: (val) {
            getPaketStreamingProvider(context).setSearchProduct(val);
          },
          onClearSearch: () {
            getPaketStreamingProvider(
              context,
          ...
          onSortSelected: (sortBy) {
            getPaketStreamingProvider(context).setSortProduct(sortBy);
          },
        );
      },
    );
        ...
        return RefreshableList(
          ...
          itemBuilder: (context, provider, index) {
            ...
            return CardProductPulsa(
              ...
              isPulsa: true,
              onPress: () {
                getPaketStreamingProvider(context).setSelectedProduct(product);
              },
            );
          },
