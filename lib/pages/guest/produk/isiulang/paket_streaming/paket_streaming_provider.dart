...
class PaketStreamingState extends Equatable {
  // Provider API
...
class PaketStreamingProvider extends Cubit<PaketStreamingState> {
  final ProdukService _produkService = ProdukService();

  PaketStreamingProvider()
    : super(
        PaketStreamingState(
  ...
  Future<void> fetchProviders() async {
    ...
    try {
      final result = await _produkService.getStreamingGuestProviders();
      ...
      if (data != null) {
        ...
        emit(
          state.copyWith(
            ...
            apiFetchProviderMessage: 'Data provider paket streaming kosong',
          ),
        );
      }
  ...
  Future<void> fetchProducts() async {
    ...
    try {
      final result = await _produkService.getStreamingGuestProducts(
      ...
      if (data != null) {
        ...
        emit(
          state.copyWith(
            ...
            apiFetchProductMessage: 'Data produk paket streaming kosong',
          ),
        );
      }
    } on ServerException catch (e) {
...
PaketStreamingProvider getPaketStreamingProvider(BuildContext context) =>
    context.read<PaketStreamingProvider>();
