...
class PaketTvState extends Equatable {
  // Provider API
...
class PaketTvProvider extends Cubit<PaketTvState> {
  ...
  Future<void> fetchProviders() async {
    ...
    try {
      final result = await _produkService.getTVGuestProviders();
  ...
  Future<void> fetchProducts() async {
    ...
    try {
      final result = await _produkService.getTVGuestProducts(
...
PaketTvProvider getPaketTvProvider(BuildContext context) =>
    context.read<PaketTvProvider>();
