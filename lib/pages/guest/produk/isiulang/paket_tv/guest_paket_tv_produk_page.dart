...
class _GuestPaketTvProdukPageState extends State<GuestPaketTvProdukPage> {
  ...
  Future<void> _onRefresh() async {
    getPaketTvProvider(context).fetchProducts();
  }
    ...
    return BlocBuilder<PaketTvProvider, PaketTvState>(
      ...
      builder: (context, state) {
        return SortFilterProduct(
          ...
          onSearchChanged: (val) {
            getPaketTvProvider(context).setSearchProduct(val);
          },
          onClearSearch: () {
            getPaketTvProvider(
              context,
          ...
          onSortSelected: (sortBy) {
            getPaketTvProvider(context).setSortProduct(sortBy);
          },
        );
      },
    );
        ...
        return RefreshableList(
          ...
          itemBuilder: (context, provider, index) {
            ...
            return CardProductPulsa(
              ...
              isPulsa: true,
              onPress: () {
                getPaketTvProvider(context).setSelectedProduct(product);
              },
            );
          },
