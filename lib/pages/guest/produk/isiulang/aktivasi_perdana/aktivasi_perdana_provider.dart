...
class AktivasiPerdanaState extends Equatable {
  // Provider API
...
class AktivasiPerdanaProvider extends Cubit<AktivasiPerdanaState> {
  final ProdukService _produkService = ProdukService();

  AktivasiPerdanaProvider()
    : super(
        AktivasiPerdanaState(
...
AktivasiPerdanaProvider getAktivasiPerdanaProvider(BuildContext context) =>
    context.read<AktivasiPerdanaProvider>();
