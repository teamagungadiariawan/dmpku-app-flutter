...
class GuestAktivasiPerdanaProviderPage extends StatefulWidget {
  static const routeName = '/guest/produk/isiulang/aktivasi-perdana/provider';

  const GuestAktivasiPerdanaProviderPage({super.key});

  @override
  State<GuestAktivasiPerdanaProviderPage> createState() =>
      _GuestAktivasiPerdanaProviderPageState();
}

class _GuestAktivasiPerdanaProviderPageState
    extends State<GuestAktivasiPerdanaProviderPage> {
  final shakeKey = GlobalKey<ShakeErrorWidgetState>();

  @override
  void dispose() {
    getAktivasiPerdanaProvider(context).resetState();
    super.dispose();
  }
  ...
  Widget build(BuildContext context) {
    return AnnotatedRegion<SystemUiOverlayStyle>(
      ...
      child: WillPopScope(
        ...
        child: Scaffold(
          appBar: CustomAppBar(
            title: "Pilih Provider Aktivasi Perdana",
            onBackButtonPressed: () {
              closePage();
            },
          ),
        ...
        return RefreshableList(
          ...
          itemBuilder: (context, provider, index) {
            return CardProvider(
              ...
              onPressed: () {
                pushNamed(GuestAktivasiPerdanaProdukPage.routeName);
            ...
            children: [
              ...
              Expanded(
                child: TextField(
                  ...
                  onChanged: getAktivasiPerdanaProvider(
                    context,
                  ).setSearchProvider,
