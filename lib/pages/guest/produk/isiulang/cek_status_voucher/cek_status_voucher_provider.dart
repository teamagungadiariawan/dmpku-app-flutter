...
class CekStatusVoucherState extends Equatable {
  // Product API
  ...
  CekStatusVoucherState copyWith({
    // Provider API
...
class CekStatusVoucherProvider extends Cubit<CekStatusVoucherState> {
  final ProdukService _produkService = ProdukService();

  CekStatusVoucherProvider()
    : super(
        CekStatusVoucherState(
...
CekStatusVoucherProvider getCekStatusVoucherProvider(BuildContext context) =>
    context.read<CekStatusVoucherProvider>();
