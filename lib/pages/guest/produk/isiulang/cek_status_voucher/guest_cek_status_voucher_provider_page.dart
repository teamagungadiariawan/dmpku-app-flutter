...
class GuestCekStatusVoucherProviderPage extends StatefulWidget {
  static const routeName = '/guest/produk/isiulang/cek-status-voucher/provider';

  const GuestCekStatusVoucherProviderPage({super.key});

  @override
  State<GuestCekStatusVoucherProviderPage> createState() =>
      _GuestCekStatusVoucherProviderPageState();
}

class _GuestCekStatusVoucherProviderPageState
    extends State<GuestCekStatusVoucherProviderPage> {
  ...
  Widget build(BuildContext context) {
    return AnnotatedRegion<SystemUiOverlayStyle>(
      ...
      child: WillPopScope(
        ...
        child: Scaffold(
          appBar: CustomAppBar(
            title: "Pilih Provider Cek Status Voucher",
            onBackButtonPressed: () {
              closePage();
            },
          ),
            ...
            children: [
              ...
              Expanded(
                child: TextField(
                  ...
                  onChanged: getCekStatusVoucherProvider(
                    context,
                  ).setSearchProduct,
