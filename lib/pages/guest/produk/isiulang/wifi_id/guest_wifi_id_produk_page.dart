...
class GuestWifiIdProdukPage extends StatefulWidget {
  static const String routeName = '/guest/produk/isiulang/wifi-id/produk';
...
class _GuestWifiIdProdukPageState extends State<GuestWifiIdProdukPage> {
    ...
    return AnnotatedRegion<SystemUiOverlayStyle>(
      ...
      child: WillPopScope(
        ...
        child: Scaffold(
          ...
          bottomNavigationBar: BlocBuilder<WifiIdProvider, WifiIdState>(
  ...
  Widget _buildIdAkunCard(BuildContext context) {
    return BlocBuilder<WifiIdProvider, WifiIdState>(
      buildWhen: (previous, current) =>
          previous.tujuan != current.tujuan ||
          previous.tujuanHasError != current.tujuanHasError,
      builder: (context, state) {
    ...
    return BlocBuilder<WifiIdProvider, WifiIdState>(
      ...
      builder: (context, state) {
        return SortFilterProduct(
          ...
          onSearchChanged: (val) {
            getWifiIdProvider(context).setSearchProduct(val);
          },
          onClearSearch: () {
            getWifiIdProvider(
              context,
          ...
          onSortSelected: (sortBy) {
            getWifiIdProvider(context).setSortProduct(sortBy);
          },
        );
      },
    );
        ...
        return RefreshableList(
          ...
          itemBuilder: (context, provider, index) {
            ...
            return CardProduct(
              ...
              onPress: () {
                getWifiIdProvider(context).setSelectedProduct(product);
              },
            );
          },
