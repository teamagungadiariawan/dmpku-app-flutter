...
// STATE
// ============================================================
class WifiIdState extends Equatable {
  // Product API
...
// CUBIT
// ============================================================
class WifiIdProvider extends Cubit<WifiIdState> {
  final ProdukService _produkService = ProdukService();

  WifiIdProvider() : super(WifiIdState(
  ...
  Future<void> fetchProducts() async {
    ...
    try {
      final result = await _produkService.getWifiIdGuestProducts();
...
WifiIdProvider getWifiIdProvider(BuildContext context) =>
    context.read<WifiIdProvider>();
