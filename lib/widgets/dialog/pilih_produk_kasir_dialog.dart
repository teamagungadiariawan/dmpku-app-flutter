...
class PilihProdukKasirDialog<B extends BlocBase<S>, S> extends StatefulWidget {
  final String title;
  final String subtitle;

  final List<ProdukModel> items;
  final Function(ProdukModel)? onSelected;
  ...
  static void show<B extends BlocBase<S>, S>(
    ...
    List<ProdukModel> items = const [],
    Function(ProdukModel)? onSelected,
    ...
    showModalBottomSheet(
      ...
      builder: (_) => bloc != null
          ? BlocProvider<B>.value(
              value: bloc,
              child: PilihProdukKasirDialog<B, S>(
                title: title,
                subtitle: subtitle,
                items: items,
  ...
  @override
  State<PilihProdukKasirDialog<B, S>> createState() =>
      _PilihProdukKasirDialogState<B, S>();
}

class _PilihProdukKasirDialogState<B extends BlocBase<S>, S>
    extends State<PilihProdukKasirDialog<B, S>> {
  final TextEditingController _searchController = TextEditingController();
  List<ProdukModel> _filteredItems = [];
  ...
  @override
  void didUpdateWidget(covariant PilihProdukKasirDialog<B, S> oldWidget) {
  ...
  Widget _buildRefreshableList(BuildContext context, bool isLoading) {
    return RefreshableList<ProdukModel>(
      isLoading: isLoading,
      ...
      itemBuilder: (context, item, index) {
        return CardProvider(
          ...
          subtitle:
              "Stok: ${item.jumlah} ${item.satuan} • Rp ${ToCurrency(item.hargajual.toString())}",
          showImage: false,
          onPressed: () {
