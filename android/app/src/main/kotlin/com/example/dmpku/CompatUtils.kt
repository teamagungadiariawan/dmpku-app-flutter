...
object CompatUtils {
    ...
    // Konstruktor default tidak perlu di Kotlin object
    ...
    @JvmStatic // Agar bisa dipanggil statis dari Java (jika diperlukan)
    fun getNavigationBarInteractionMode(@NonNull context: Context): Int {
